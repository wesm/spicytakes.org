...
date: 2019-01-15
url: https://drewdevault.com/2019/01/15/Im-doing-FOSS-full-time.html
slug: Im-doing-FOSS-full-time
word_count: 535
---
...
projects, including  [sway](https://github.com/swaywm/sway) ,  [wlroots](https://github.com/swaywm/wlroots) ,  [sr.ht](https://sr.ht) ,
 [scdoc](https://git.sr.ht/~sircmpwn/scdoc) ,  [aerc](https://git.sr.ht/~sircmpwn/aerc2) , and  [many](https://git.sr.ht/~sircmpwn) ,  [many](https://github.com/ddevault) 
more. I contribute to more still, working on projects like  [Alpine
Linux](https://alpinelinux.org) ,  [mrsh](https://git.sr.ht/~emersion/mrsh) ,  [musl libc](https://musl-libc.org) , and anything else I can. Until
now, I’ve been working on these in my spare time, but just under a year ago I
wrote “ [The path to sustainably working on FOSS full-time](https://drewdevault.com/2018/02/24/The-road-to-sustainable-FOSS.html) ” laying out
