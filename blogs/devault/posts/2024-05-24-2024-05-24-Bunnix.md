...
up the keyboard via PS/2, and  YMMV 
...
from the community – send patches to my  [public inbox](https://lists.sr.ht/~sircmpwn/public-inbox) . But for the most
...
1. sbase is good software written by questionable people. I do not endorse suckless. ↩︎
