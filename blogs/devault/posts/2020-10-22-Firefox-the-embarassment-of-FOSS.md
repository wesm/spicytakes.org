...
date: 2020-10-22
url: https://drewdevault.com/2020/10/22/Firefox-the-embarassment-of-FOSS.html
slug: Firefox-the-embarassment-of-FOSS
word_count: 467
---
...
And, yesterday,  [Mozilla published a statement](https://blog.mozilla.org/blog/2020/10/20/mozilla-reaction-to-u-s-v-google/)  siding with
...
As I have  [stated before](/2020/03/18/Reckless-limitless-scope.html) , the scope of web browsers has been
...
web. This is why I’m throwing my weight behind  [Gemini](https://gemini.circumlunar.space/) , a new protocol
...
1. [Mozilla cuts 250 jobs, says Firefox development will be affected](https://arstechnica.com/information-technology/2020/08/firefox-maker-mozilla-lays-off-250-workers-says-covid-19-lowered-revenue/) ↩︎
2. [Firefox usage is down 85% despite Mozilla’s top exec pay going up 400%](http://calpaterson.com/mozilla.html) ↩︎
3. [Firefox continues push to bring DNS over HTTPS by default for US users](https://blog.mozilla.org/blog/2020/02/25/firefox-continues-push-to-bring-dns-over-https-by-default-for-us-users/) ↩︎
4. [A Privacy-Conscious Approach to Sponsored Content](https://blog.mozilla.org/futurereleases/2018/04/30/a-privacy-conscious-approach-to-sponsored-content/) ↩︎
5. [Mozilla VPN](https://vpn.mozilla.org/) ↩︎
6. [Technical Details on the Recent Firefox Add-on Outage](https://hacks.mozilla.org/2019/05/technical-details-on-the-recent-firefox-add-on-outage/) ↩︎
7. [Killed by Mozilla](https://killedbymozilla.com/) ↩︎
