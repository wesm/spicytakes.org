...
date: 2019-09-08
url: https://drewdevault.com/2019/09/08/Enough-to-decide.html
slug: Enough-to-decide
word_count: 909
---
...
Pros: it’s  *SAFE* , useful for systems programming,
...
Pros:  [entertaining](https://github.com/Perl/perl5/blob/blead/Configure) , best in class at regexes/string munging,
...
Cons: ill-defined, far too big,  *
Object Oriented Programming* , loads of baggage, ecosystem that buys into
...
Pros: It’s both  *ENTERPRISE*  and  *HIP*  at the same time, and therefore effective at herding a
...
Pros: more expressive than Java, useful for  *Big
Data*  problems.
...
1. Except one, and it can go suck an egg for all I care. ↩︎
2. but not production-grade. ↩︎
