...
date: 2018-11-15
url: https://drewdevault.com/2018/11/15/sr.ht-general-availability.html
slug: sr.ht-general-availability
word_count: 951
---
...
projects. Take a look at the  [sr.ht-dev](https://lists.sr.ht/~sircmpwn/sr.ht-dev)  list to see patches
developed for sr.ht itself. Another good read is the  [mrsh-dev](https://lists.sr.ht/~emersion/mrsh-dev)  list,
used for development on the  [mrsh](https://git.sr.ht/~emersion/mrsh)  project, or my own  [public
inbox](https://lists.sr.ht/~sircmpwn/public-inbox) , where I take comments for this blog and grab-bag
...
1. Some components use the 3-clause BSD license. ↩︎
2. A model that many have replicated in their own GitHub alternatives. ↩︎
