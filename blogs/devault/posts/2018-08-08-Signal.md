...
date: 2018-08-08
url: https://drewdevault.com/2018/08/08/Signal.html
slug: Signal
word_count: 1923
---
...
to  [animated gif search](https://signal.org/blog/signal-and-giphy-update/) , a very important feature for security
concious users. I bet that  [50 million dollar donation](https://signal.org/blog/signal-foundation/)  could help,
...
up for “ [harm reduction](https://github.com/signalapp/Signal-Android/issues/127#issuecomment-286223680) ”, to avoid people using unofficial
...
1. “But how is AOSP any better?” This is a common strawman counter-argument. Fact: There is empirical evidence which shows that Google Play Services does silent updates and can obtain any permission on your phone: a rootkit. There is no empirical evidence to suggest AOSP has similar functionality. ↩︎
2. No, it’s not. ↩︎
3. Probably not, because that wouldn’t be self-serving. But I’m getting ahead of myself. ↩︎
4. See [LibreSignal](https://github.com/LibreSignal/LibreSignal) and [Silence](https://github.com/SilenceIM/Silence#silence-), particularly [this thread](https://github.com/LibreSignal/LibreSignal/issues/37#issuecomment-217211165). ↩︎
5. See [Reflections: The ecosystem is moving](https://signal.org/blog/the-ecosystem-is-moving/). Yes, that’s the unedited title. ↩︎
