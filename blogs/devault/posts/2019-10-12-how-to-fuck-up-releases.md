...
mistake when picking the correct version number. So, I wrote a small script:
 [semver](https://paste.sr.ht/~sircmpwn/34bd575b4c37ae6102d6ede2a4ba17b2e1bb9cf8) .  `semver patch`  bumps the patch version,  `semver minor`  bumps the minor version, and
