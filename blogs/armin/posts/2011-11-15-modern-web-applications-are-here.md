...
summary: "Battlefield 3's Battlelog system is an interesting web application that many of us missed.  Here is why it's amazing and worth a look at."
date: 2011-11-15T00:00:00
tags: ["python", "web", "battlefield", "thoughts"]
slug: modern-web-applications-are-here
word_count: 3040
source_file: blog/posts/2011/11-15-modern-web-applications-are-here.md
---
...
Battlelog is written by a company called [ESN](http://esn.me/) and their
...
1. Generating HTML on the server side is more expensive than on the
...
1. Based on that information as well as your filter settings, Battlelog
