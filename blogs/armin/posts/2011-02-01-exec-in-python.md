...
summary: "How `exec` and `eval` work in Python and a number of reasons why you don't want to use them."
date: 2011-02-01T00:00:00
tags: ["python"]
slug: exec-in-python
word_count: 3116
source_file: blog/posts/2011/02-01-exec-in-python.md
---
...
1. Now depending on the import hook responsible it might load bytecode
