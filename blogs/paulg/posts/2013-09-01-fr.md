...
of explosions as these two volatile components combine.[1]If you're an inexperienced founder, the only way to survive is by
...
Actually it isn't.Rapid growthis what
...
you try to raise money before you canconvinceinvestors, you'll not only waste your time, but also burn your
...
consumes but that it becomes thetop idea in
your mind.  A startup can't endure that level of distraction
for long.  An early stage startup grows mostly because the foundersmakeit grow, and if the founders look away,
...
quickly and get back to work.[2]You can take money from investors when you're not in fundraising
...
need to focus on the company.[6]Companies that are successful at raising money in phase 2 sometimes
...
been about to.[8]That's not the worst thing investors will do.  Some will use language
...
meet them half way.[9]Fortunately, the next rule is a tactic for neutralizing this behavior.
...
about this that we designed aprotocolto fix the
...
parallel, but give higher priority to the more promising ones.[10]Expected value = how likely an investor is to say yes, multiplied
...
such investors last, if at all.[11]Doing breadth-first search weighted by expected value will save you
...
they're already running through that in their heads.[12]If you're experienced at negotiations, you already know how to ask
...
at this and ask how their process works and where you are in it.[14]Get the first commitment.The biggest factor in most investors' opinions of you is the opinion
ofother investors.  Once you start getting
...
things rolling.[15]Close committed money.It's not a deal till the money's in the bank.  I often hear
...
your cofounder could quit.[16]Even a day's delay can bring news that causes an investor to change
...
investor will say yes, but the probability that they'd be thefirstto say yes, and the latter is not simply a constant fraction of the
...
to mean they won't invest unless you can raise more elsewhere.)[17]Where does this term "lead" come from?  Up till a few years ago,
...
the solution I recommend forpitchingyour startup: do the right thing and then just tell investors what
...
million.[18]Underestimate how much you want.Though you can focus on different plans when talking to different
...
And the best way not to seem desperate is not tobedesperate.
That's one reason we urge startups during YC to keep expenses low
and to try to make it toramen
profitabilitybefore Demo Day.  Though it sounds slightly
...
a position of strength without being profitable.[19]Don't optimize for valuation.When you raise money, what should your valuation be?  The most
...
won't invest in at a cap of $x will have an easier time at $x/2.[20]Yes/no before valuation.Some investors want to know what your valuation is before they even
...
as you combine it with the next one.[21]Beware "valuation sensitive" investors.Occasionally you'll encounter investors who describe themselves as
...
may need to.[22]It might seem that instead of accepting offers greedily, your goal
...
algorithm tells you what to do.[23]Don't sell more than 25% in phase 2.If you do well, you will probably raise a series A round eventually.
...
an A round.[24]Which means you should avoid doing things in earlier rounds that
...
founder(s) from the details of the process.[25](https://paulgraham.com/If the founders mistrust one another, this could cause some friction.
...
stage startup often consists of unglamorousschleps.  Whereas fundraising, when it's
...
over lunch at a nice restaurant.[26]The danger of fundraising is particularly acute for people who are
...
usual that pride goeth before a fall.[27]Be nice when investors reject you as well.  The best investors are
...
be the surest way to that destination.Be good, take care of yourselves, anddon't leave the path.Notes[1]
...
fashions.)[2]
One YC founder told me:I think in general we've done ok at fundraising, but I managed
  to screw up twice at the exact same thing — trying to focus
  on building the company and fundraising at the same time.[3]
...
One YC founder who read a draft of this essay wrote:This is the most important section. I think it might bear stating
  ...
  is just feigning interest — until you get a definite commitment."[10]
...
told me:Investors are professional negotiators and can negotiate on the
  ...
  commitments. I used to do this all the time.[26]
...
this:It's hard to mentally deal with the sheer scale of rejection in
  ...
  listing) in order to win.[27]
The actual sentence in the King James Bible is "Pride goeth
before destruction, and an haughty spirit before a fall."Thanksto Slava Akhmechet, Sam Altman, Nate Blecharczyk,
