...
market must not exist.[1]Actually startups take off because the founders make them take off.
...
have to spend a lot of time on sales and marketing.[2]The other reason founders ignore this path is that the absolute
...
startup to measure their progress by weeklygrowth
...
manually and then gradually switch to less manual methods.[3]Airbnb is a classic example of this technique.  Marketplaces are
...
the size it turned out to be.[4]The question to ask about an early stage startup is not "is this
...
to solveyour own problems, then
...
that worked well.[5]DelightYou should take extraordinary measures not just to acquire users,
...
company can.[6]Once you realize that existing conventions are not the upper bound
...
is always inaccurate, even if you're one of them.[7]The feedback you get from engaging directly with your earliest users
...
the market in which you can get a critical mass of users quickly.[8]Most startups that use the contained fire strategy do it unconsciously.
...
hundreds of other startups ready at hand.MerakiForhardware startupsthere's a variant of
...
Pebblesassembledthe first several hundred watches themselves. If
...
that's as much as any startup needs initially.[9]Consulting is the canonical example of work that doesn't scale.
...
made those users than how many there were of them.[10]So why do founders think launches matter?  A combination of solipsism
...
nothing out of it.[11]It's not enough just to do something extraordinary initially.  You
have to make an extraordinaryeffortinitially.  Any strategy
...
they need to work hard in two dimensions.[12]In the best case, both components of the vector contribute to your
...
manually — is probably a bad idea, at least for those founders.Thanksto Sam Altman, Paul Buchheit, Patrick Collison, Kevin
