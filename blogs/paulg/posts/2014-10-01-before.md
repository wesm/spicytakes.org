...
October 2014(This essay is derived from a guest lecture in Sam Altman'sstartup classat
...
instructors.[1]You can, however, trust your instincts about people.  And in fact
...
tricks are for convincing investors.  We tell them the best way toconvince investorsis to make a startup
that's actually doing well, meaninggrowing fast, and then simply
...
work, and what would you like to win by doing?[4]All-ConsumingThat brings us to our fourth counterintuitive point: startups are
...
be that for long.[6]Given this dichotomy, which of the two paths should you take?  Be
...
you'll never get to do it.[7]Mark Zuckerberg will never get to bum around a foreign country.  He
...
tomake themtake off, and it's gratuitously
...
much that waslikebeing a startup founder.
...
that threshold.  The hard part was predicting howtough and ambitiousthey would become.  There
...
startup ideas is not to try to think of startup ideas.I've written a wholeessayon this,
...
were working on important problems thatno
one elseat the time thought were important, and in particular
...
know when you're working on real stuff?[8]I know howIknow.  Real problems are interesting, and I am
...
Combinator itselfwas something I only did because it seemed
...
And indeed, probably also the best way to live.[9]But although I can't explain in the general case what counts as an
...
follow your own inclinations.[10]The component of entrepreneurship that really matters is domain
...
Some founders listen more than others, and this tends to be apredictor of success. One of the things I
...
In a startup you have to spend a lot of time onschleps, but this sort of work is merely
...
news: usersdon't carewhat your GPA
...
you got in them.Thanksto Sam Altman, Paul Buchheit, John Collison, Patrick
