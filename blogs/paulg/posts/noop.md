...
![Why Arc Isn't Especially Object-Oriented](https://s.turbifycdn.com/aah/paulgraham/why-arc-isn-t-especially-object-oriented-3.gif)

There is a kind of mania for object-oriented programming at the moment, butsome of thesmartest programmersI know are some of the least excited about it.My own feeling is that object-oriented
...
limitations.  (SeeGreenspun's Tenth Rule.)Object-oriented programming is popular in big companies,
...
systems.I personally have never needed object-oriented abstractions.
