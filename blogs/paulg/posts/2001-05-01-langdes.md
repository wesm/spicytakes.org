...
In fact I think you ought to design for thebest programmers, but
...
Whether to do anything about it, if it is true, is another question.3. What Do You Need for Server-Based Software?I think a lot of the most exciting new applications that get written
...
effect ofsubroutinesin the inherently 
...
would not be surprised ifmostprograms started as throwaway
...
just so much more robust to have all thebrains on the server.2. Object-Oriented Programming.I realize this is a
