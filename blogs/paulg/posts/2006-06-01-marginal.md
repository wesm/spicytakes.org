...
of existing popular novels — roughlyGone with the WindplusRoots.  But its bulk and celebrity would make it a bestseller
...
it would be a byword for bogusness like Milli Vanilli orBattlefield
...
image of a great artist: it's thestandardimage.  I'm not
...
or medicine.[2]If it's corrupt enough, a test becomes an anti-test, filtering out
the people it should select by making them to do things only the
wrong people would do.Popularityin high school
...
of those fluffy idealized portraits of countesses with their lapdogs.Chardindecided to skip all that and paint ordinary things as he
...
because it's followed immediately by less hackable tests.[4]RiskEven in a field with honest tests, there are still advantages to
...
got a wistful look when he said this — that he gotso much
...
responsible for a lot of the worst flaws inprogramming languages.
...
because no one has yet explored its possibilities.  BeforeDurertried making engravings, no one took them very seriously.  Engraving
...
say, making masterpieces incomicsmight seem to the average person
...
But there's amagicin small things that goes beyond such rational
...
more than compensates.[5]So if you're an outsider, take advantage of your ability to make
...
dangerous forms ofprocrastinationare those that seem like work,
...
this wasn't whatmadethem eminent — it was more a flaw their
...
beginning to realize how muchdeeperbloggers can dig than
journalists, how muchmore interestinga democratic news site can be than a
front page controlled by editors, and how muchfunniera bunch of kids
...
there were too few insiders to explore everything.This is why I spend most of my time writingessayslately.  The
...
you've probably done something good.If you make something and people complain that it doesn'twork,
...
withSteve 
Wozniakin Jessica Livingston'sFounders at Work.[2]
...
you'reexpectedto do more with less, then you're being
...
and over for two weeks.Thanksto Sam Altman, Trevor Blackwell, Paul Buchheit, Sarah
