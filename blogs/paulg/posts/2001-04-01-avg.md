...
Developer Symposium.)In the summer of 1995, my friend Robert Morris and I
started a startup calledViaweb.  
...
should consider learning Lisp:Lisp is worth learning for the profound enlightenment experience
  you will have when you finally get it; that experience will make
  you a better programmer for the rest of your days, even if you
  never actually use Lisp itself a lot.This is the same argument you tend to hear for learning Latin.  It
...
thought possible.When I was about nine I happened to get hold of a copy ofThe Day
...
the last I heard there were about 20,000.The Blub ParadoxWhat's so great about Lisp?  And if Lisp is so great, why doesn't
...
understand what it meant.  InAnsi Common LispI tried to move
...
know,  Lisp code.  (SeeGreenspun's Tenth Rule.)[2] Robert Morris says that I didn't need to be secretive, because
...
[More Technical Details](https://paulgraham.com/lwba.html)
...
[Orbitz Uses Lisp Too](https://paulgraham.com/carl.html)
