...
(This essay is from the introduction toOn Lisp.)It's a long-standing principle of programming style that the functional
...
calledtop-down design:you say "the purpose of the
...
could be calledbottom-up design-- changing the language
to suit the problem.
...
clear, small, and efficient.It's worth emphasizing that bottom-up design doesn't mean
...
you'll get an arch.In typical code, once you abstract out the parts which are
...
This brings several advantages:By making the language do more of the work, bottom-up design
...
start with raw Lisp.Bottom-up design makes programs easier to read.An instance of this type
...
perhaps to redesign the program in a simpler way.Bottom-up design is possible to a certain degree in languages
...
group.  InThe Mythical Man-Month,
Frederick Brooks
...
techniques that Lisp makes possible, it canwin outright.New:Download On Lisp for Free.[1] "But no one can read
