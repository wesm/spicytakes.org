...
date: 2019-06-08
url: https://blog.cleancoder.com/uncle-bob/2019/06/08/TestsAndTypes.html
slug: TestsAndTypes
word_count: 1742
---
...
> There is no escape from this. Whether you use static, or dynamic typing, you must still demonstrate correctness by executing tests. Static typing does not reduce that number of tests, because those tests are behavioral and empirical. — Uncle Bob Martin (@unclebobmartin)  [June 4, 2019](https://twitter.com/unclebobmartin/status/1135894376222265345?ref_src=twsrc%5Etfw)
...
> I respectfully disagree with this. Some type systems allow null references. In those type systems, you must write tests that demonstrate how the SUT interacts with null input.
> In other type systems (e.g. Haskell) nulls don't exist. You can't meaningfully write an equivalent test — Mark Seemann (@ploeh)  [June 4, 2019](https://twitter.com/ploeh/status/1135896304561901570?ref_src=twsrc%5Etfw)
