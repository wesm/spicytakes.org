...
If you are a Java programmer, you’d be worried about the stack overflowing.  But in functional languages (and in most other modern languages other than Java) there is a lovely little trick called  [*Tail Call Optimization*](http://wiki.c2.com/?TailCallOptimization)  that eliminates that problem if the recursive call is the very last operation of the function.
