...
tags: ["ursa labs", "work"]
slug: ursa-labs-partner-nvidia
word_count: 389
source_file: blog/ursa-labs-partner-nvidia/index.qmd
content_type: blog
---

I'm excited to announce that [NVIDIA AI Labs][2] has signed on as a supporter
of [Ursa Labs][1]. NVIDIA's new open source [RAPIDS][10] data science platform
uses [Apache Arrow][3] for an interoperable representation of tabular data
...
Initiative][5] last year to build libraries of pandas-style analytics for
...
feed][4] will know that Apache Arrow is fundamentally about making it easy to
...
Arrow development community. Initially, [Graphistry][6] contributed a
TypeScript implementation of Arrow for use in JavaScript. I contributed
accelerated Arrow-based data ingest to the [MapD GPU database][7]. We now have
...
larger team and continuing to make progress on the [tech roadmap][8].

If you or your company would be interested in becoming a sponsor also, please
get in touch with us at [info@ursalabs.org][9].

[1]: https://ursalabs.org
[2]: https://nvidia.com
[3]: http://arrow.apache.org
[4]: https://twitter.com/wesmckinn
[5]: http://gpuopenanalytics.com
[6]: https://graphistry.com
[7]: https://github.com/omnisci/mapd-core
[8]: https://ursalabs.org/tech
[9]: mailto:info@ursalabs.org
[10]: https://RAPIDS.ai