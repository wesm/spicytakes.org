...
tags: ["pandas", "apache arrow"]
slug: apache-arrow-pandas-internals
word_count: 3650
source_file: blog/apache-arrow-pandas-internals/index.qmd
content_type: blog
---
...
> Side note: consider making a [tax-deductible donation][16] to support pandas
  development
...
about it][2] all the way back in July 2011.
...
I started DataPad in 2013 with [Chang She][3], my longtime friend and pandas
...
board. You can see a [demo of DataPad here][4].
...
I gave a [talk in November 2013][1] with the subtitle *10 Things I Hate About
...
worked with the Apache Software Foundation to establish [Apache Arrow][6].
...
Also in late 2015, I wrote a [long set of design documents][14] to start
...
based on consensus][15] (with me as the BDFL to break impasses). I wanted to
...
* A zero-copy, streaming / chunk-oriented data layer designed for [moving and
  accessing large datasets at maximum speeds][22]
...
discussion of issues around this, see [Jake Vanderplas's][24] epic exposé on
[Why Python is Slow][23].
...
Arrow serialization design provides a ["data header"][12] which describes the
...
this applied to great effect in the [Plasma Object Store][8] (now part of
Arrow) used in the [Ray project][13] at UC Berkeley.
...
stream"][22], a sequence of atomic tables together comprising a large
dataset. This stream processing data model is an idea for databases which serve
streams of records from a database cursor.

We have been developing [a high-speed connector with Parquet format][9]. We've
also seen the optimized [turbodbc][10] project for ODBC-based database
connections.
...
To plan ahead for this use case, in 2015, I started the [Ibis project][20]
...
package][21]. [Phillip Cloud][26] from the pandas core team has been actively
...
Nowadays, a lot of people ask me about [Dask][11] (and Spark, and other such
...
entire dataset. Truly, what [Matt Rocklin][25] and team have built is an
...
[1]: https://www.slideshare.net/wesm/practical-medium-data-analytics-with-python
[2]: http://wesmckinney.com/blog/a-roadmap-for-rich-scientific-data-structures-in-python/
[3]: https://github.com/changhiskhan
[4]: https://www.youtube.com/watch?v=wPEmoT018s8
[5]: https://www.dremio.com/
[6]: http://arrow.apache.org/
[7]: https://www.youtube.com/watch?v=wdmf1msbtVs
[8]: http://arrow.apache.org/blog/2017/08/08/plasma-in-memory-object-store/
[9]: http://wesmckinney.com/blog/python-parquet-update/
[10]: http://arrow.apache.org/blog/2017/06/16/turbodbc-arrow/
[11]: http://dask.pydata.org
[12]: https://github.com/apache/arrow/blob/master/format/Message.fbs#L44
[13]: https://github.com/ray-project/ray
[14]: https://pandas-dev.github.io/pandas2/
[15]: https://github.com/pandas-dev/pandas-governance
[16]: http://pandas.pydata.org/donate.html
[17]: https://github.com/libdynd/libdynd
[18]: https://mail.scipy.org/pipermail/numpy-discussion/2015-August/073412.html
[19]: https://mail.scipy.org/pipermail/numpy-discussion/2014-September/071243.html
[20]: https://github.com/ibis-project/ibis
[21]: https://github.com/tidyverse/dplyr
[22]: http://wesmckinney.com/blog/arrow-streaming-columnar/
[23]: http://jakevdp.github.io/blog/2014/05/09/why-python-is-slow/
[24]: https://github.com/jakevdp
[25]: https://github.com/mrocklin
[26]: https://github.com/cpcloud