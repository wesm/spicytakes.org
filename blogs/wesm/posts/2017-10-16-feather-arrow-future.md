...
tags: ["apache arrow"]
slug: feather-arrow-future
word_count: 900
source_file: blog/feather-arrow-future/index.qmd
content_type: blog
---
...
Shortly after we announced the [formation of Apache Arrow][1] in February 2016,
[Hadley Wickham][2] and I met up and discussed how we could foster more
...
with just enough [file metadata][3] to support the major Python and R data
types. We released this as the [Feather project][4]. The implementation was
...
conversions][5]. We have had multithreaded conversions from Arrow to pandas
...
on the Feather 0.3.1 codebase from the [wesm/feather][7] repository. Once that
...
[1]: https://blogs.apache.org/foundation/entry/the_apache_software_foundation_announces87
[2]: https://hadley.nz/
[3]: https://wesmckinney.com/blog/feather-its-the-metadata/
[4]: https://blog.cloudera.com/blog/2016/03/feather-a-fast-on-disk-format-for-data-frames-for-r-and-python-powered-by-apache-arrow/
[5]: https://wesmckinney.com/blog/arrow-streaming-columnar/
[6]: https://gist.github.com/wesm/5dd0d5e6577969f2d1cad35911d4865f
[7]: https://github.com/wesm/feather