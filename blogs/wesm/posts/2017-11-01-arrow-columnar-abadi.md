...
tags: ["apache arrow", "databases"]
slug: arrow-columnar-abadi
word_count: 1631
source_file: blog/arrow-columnar-abadi/index.qmd
content_type: blog
---

Well-known database systems researcher [Daniel Abadi][2] published a blog post
yesterday asking [Apache Arrow vs. Parquet and ORC: Do we really need a third
Apache project for columnar data representation?][1].
...
* Arrow is an ephemeral, runtime in-memory representation that can be processed
  ...
  can [use it to create file formats][6]) nor is it intended for long-term
  storage
...
science in my September 21 blog post][5].
...
* [Zero-copy reads of machine learning datasets in the Ray project][7]
* [Vectorized UDFs in Apache Spark][8]
* [Faster data ingest from Python in the MapD GPU database][9]
* [On-GPU IPC for the GPU Open Analytics Initiative][10]
...
See [ARROW-300][3]. Support for other kinds of compression has been discussed
...
ZSTD][4]. We could certainly add RLE, bit-packing, or other compression
...
[2]: http://www.cs.yale.edu/homes/dna/
[3]: https://issues.apache.org/jira/browse/ARROW-300
[4]: https://github.com/apache/arrow/tree/master/cpp/src/arrow/util
[5]: https://wesmckinney.com/blog/apache-arrow-pandas-internals/
[6]: https://wesmckinney.com/blog/feather-arrow-future/
[7]: http://arrow.apache.org/blog/2017/10/15/fast-python-serialization-with-ray-and-arrow/
[8]: https://databricks.com/blog/2017/10/30/introducing-vectorized-udfs-for-pyspark.html
[9]: https://github.com/mapd/pymapd/pull/53#issuecomment-331762835
[10]: https://www.mapd.com/blog/2017/09/26/end-to-end-machine-learning-with-goai/