...
tags: ["rants", "data science", "python", "r"]
slug: the-problem-with-the-data-science-language-wars
word_count: 937
source_file: blog/the-problem-with-the-data-science-language-wars/index.qmd
content_type: blog
---

<!-- PELICAN_BEGIN_SUMMARY -->

I really enjoyed the [cheeky blog post][1] by my pal [Rob Story][2].
...
Wickham][9] is literally working on a [new CSV reader library for R][3]. It
...
Medium Data, and analyzing it effectively [may require some cleverness][4] on
...
distributed, fault-tolerant storage ([hey Kudu!][5]). Sometimes big data is
...
As I've [discussed in recent talks][6], any data processing engine that allows you
...
As an example, [response to AWS adding Python UDF support in Redshift][7] has
...
participate. [My new project, Ibis][8], is beginning to address the Python side
...
[1]: https://medium.com/@oceankidbilly/python-vs-r-vs-cobol-which-is-best-for-data-science-7b2979c6a000#.refa7joi9
[2]: https://twitter.com/oceankidbilly
[3]: https://github.com/hadley/readr
[4]: https://twitter.com/wesmckinn/status/413159516096585729
[5]: http://getkudu.io
[6]: http://www.slideshare.net/wesm/ibis-scaling-python-analytics-on-hadoop-and-impala
[7]: https://medium.com/wunderlist-engineering/amazon-redshift-s-udf-b3d4205ae732#.k2tz5d1rv
[8]: http://blog.ibis-project.org/
[9]: http://twitter.com/hadleywickham