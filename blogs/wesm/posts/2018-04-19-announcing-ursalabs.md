...
tags: ["work", "ursa labs", "apache arrow"]
slug: announcing-ursalabs
word_count: 2816
source_file: blog/announcing-ursalabs/index.qmd
content_type: blog
---

Funding open source software development is a complicated subject. I’m excited
to announce that I’ve founded [Ursa Labs][1] ([https://ursalabs.org][1]), an
independent development lab with the mission of innovation in data science
tooling.

I am initially partnering with [RStudio][2] and [Two Sigma][3] to assist me in
...
science, all powered by [Apache Arrow][4].
...
extensively][5] in recent years in the wake of shocking security
...
such as [Tidelift][16], which has begun selling a type of “insurance policy”
...
developing pandas; in the end I convinced [Adam Klein][7] and [Chang She][6] to
...
pandas to [Jeff Reback][8], [Phillip Cloud][9], and others, who’ve done an
...
that I summarized infamously in my talk [10 Things I Hate about pandas][10]. In
September 2014, the [DataPad team and I joined Cloudera][11] to work on these
problems and more.
...
artifacts of my time at Cloudera were [Ibis][12], a lazy computational
expression framework geared toward SQL-style execution engines, and [Apache
Arrow][4], a cross-language in-memory data frame format and analytics
...
Around this time, I was lucky to connect with [Two Sigma][3], a financial
...
Apache Spark), [Berkeley RISELab][13] (Fast Python Serialization with Ray and
Apache Arrow), and the [GPGPU community][14].
...
Borders at JupyterCon][17], [Memory Interoperability for Analytics and Machine
Learning at Stanford’s ScaledML][18], [Raising the Tides: Open Source Analytics
for Data Science at the Newsweek AI and Data Science Conference][19]), we are
...
## Enter the <strike>Dragon</strike> Bear
...
world is by creating an independent organization, [Ursa Labs][1], dedicated to
...
In 2016, [Hadley Wickham][15] and I had a brief collaboration to create the
...
tools with [Matt Greenwood][20], who heads the company’s Modeling Engineering
organization and [David Palaitis][21] who manages Two Sigma’s open source
...
board of [NumFOCUS][22] and [TS Ventures][23].  I’ll continue my work with Two
...
tuned. In the meantime, we'd love to have you involved with [Apache Arrow][4].

If you are with an organization in a position to sponsor our work or partner
with us in some other way, please reach out to [info@ursalabs.org][24].

[1]: https://ursalabs.org
[2]: https://rstudio.org
[3]: https://www.twosigma.com
[4]: http://arrow.apache.org
...
[7]: https://github.com/adamklein
[8]: https://github.com/jreback
[9]: https://github.com/cpcloud
[10]: https://www.slideshare.net/wesm/practical-medium-data-analytics-with-python
[11]: https://www.cloudera.com/more/news-and-blogs/press-releases/2014-09-30-cloudera-acquires-datapad-technology-assets-and-team-to-strength.html
[12]: http://ibis-project.org/
[13]: https://rise.cs.berkeley.edu/
[14]: http://gpuopenanalytics.com
[15]: http://hadley.nz
[16]: https://tidelift.com/
[17]: https://www.youtube.com/watch?v=wdmf1msbtVs
[18]: https://www.slideshare.net/wesm/memory-interoperability-in-analytics-and-machine-learning
[19]: https://www.slideshare.net/wesm/raising-the-tides-open-source-analytics-for-data-science
[20]: https://www.crunchbase.com/person/matt-greenwood
[21]: https://github.com/tnn1t1s
[22]: https://www.numfocus.org/
[23]: https://www.twosigmaventures.com/
[24]: mailto:info@ursalabs.org