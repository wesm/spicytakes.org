...
tags: ["rants", "open source"]
slug: github-open-source-contributions
word_count: 576
source_file: blog/github-open-source-contributions/index.qmd
content_type: blog
---
...
* It only showed 1 year worth of prior work. There are projects on GitHub with
  10 or even [20 years of contribution history][1]. So if GitHub is going to be
...
example, that [Jeff Reback][2] is a real person with a day job and a family
...
[1]: https://github.com/postgres/postgres/graphs/contributors
