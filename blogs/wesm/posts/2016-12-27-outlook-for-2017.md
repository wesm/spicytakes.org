...
tags: ["apache arrow", "pandas", "ibis", "parquet", "work"]
slug: outlook-for-2017
word_count: 1077
source_file: blog/outlook-for-2017/index.qmd
content_type: blog
---
...
Analysis*][4]. I am going to do my best to write more in 2017.

<!-- PELICAN_END_SUMMARY -->

## New position

After a productive [2 years with Cloudera][2], a few months ago I transitioned
to a software architect role at [Two Sigma Investments][1]. Since leaving the
...
a bit about this [in a recent talk][5].
...
Last February, we announced [Apache Arrow][6], a collaboration amongst open
...
In 2016, we've worked to create a [production-grade C++ library][9] for reading
and writing the Apache Parquet file format. En route, I became a committer and
then a PMC member of Apache Parquet. [Uwe Korn][10], from Blue Yonder, has also
...
implementation][11] for Python that uses Numba for accelerating encoding and
decoding routines. I'm glad to see more Python developers working on these
problems.

## Feather file format

Earlier this year, I worked with [Hadley Wickham][7] to design and deliver the
[Feather file format][8] for R and Python. Feather uses Apache Arrow's columnar
...
PySpark, the Python API for [Apache Spark][14], has well known performance
...
updates to share in February at the [Spark Summit East conference][12].

## Update on Ibis

Last, but not least, I am still maintaining [Ibis][13] and helping its users
...
[1]: https://twosigma.com
[2]: http://wesmckinney.com/blog/thoughts-on-joining-cloudera/
[3]: https://github.com/twosigma/cook
[4]: http://shop.oreilly.com/product/0636920050896.do
[5]: http://www.slideshare.net/wesm/python-data-wrangling-preparing-for-the-future
[6]: http://arrow.apache.org/
[7]: http://hadley.nz
[8]: http://github.com/wesm/feather
[9]: http://github.com/apache/parquet-cpp
[10]: https://github.com/xhochy
[11]: http://github.com/dask/fastparquet
[12]: https://spark-summit.org/east-2017/
[13]: http://github.com/cloudera/ibis
