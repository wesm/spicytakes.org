...
A few months ago I had the opportunity to have dinner with [Ramit Sethi](http://www.iwillteachyoutoberich.com).  We shot the breeze about business topics for a little while — optimizing email opt-in rates, A/B testing to victory, pricing strategies, and the like.  Writing and selling software is solidly in my comfort zone and is what I usually talk about on this blog.  If you want that, **skip this post**.  We are going deep, *deep* into the fluffy bits!
