...
date: 2017-09-09
url: https://www.kalzumeus.com/2017/09/09/identity-theft-credit-reports/
slug: identity-theft-credit-reports
word_count: 6184
---
...
**That's a pretty weird hobby?**
Well, owing to systemic vulnerabilities in consumer credit infrastructure in the U.S., when I graduated college and started acting as an adult with regards to finances, I realized that my credit report contained a few hundred thousands of dollars of debt. The overwhelming majority was due to a series of errors, some dating to before I was born. Resolving that took a few months, and in the end, I had a clean credit report with one minor ding (a $100 doctor copay that I thought my parents had paid when I was in school).
In the process, I got pretty good at working some regulatory machines. (Programmer dad joke: what do you call a series of conditions and flowcharts administered by a regulatory agency? A state machine.)
I also found a forum or two with other people who had problems with their credit reports (some they were innocent of, and some where the general shape of the problem was "poor choices were made"). Since I'm constitutionally incapable of seeing a question on a message board and not answering it, I ended up writing a lot of answers. Frequently this involved me telling folks "Write a professional letter saying ...", and this ran up against the problem that folks with huge credit issues often are not capable of writing professional letters. Since I was, and was underemployed and lacking a hobby, I ghostwrote a few hundred letters and very informally quarterbacked the people who signed them as they dealt with responses.
**But why?**
Some people edit Wikipedia. Some kept Livejournals. Letters to banks were my primary writing outlet before I discovered business and blogging. It's a quirky hobby, but just trust me that I indeed had it, from approximately 2004 through 2007.
**Was that legal?**
Ask your lawyer, because I wouldn't want to inadvertently give you legal advice.
...
**Why do banks use credit scores?**
Underwriting (determining whether to issue credit and, if so, at what price) was historically done by dedicated professionals. These days, it is largely done by machines automatically on the basis of credit scores and other signals. This is probably the most consequential deployment of AI in the world (with the debatable exception of Google), and almost no one calls it AI, because it's so old that people just say "Bah humbug that's just math done against a lot of data."  Which is, to a point, true.
Why not get a human to do it? Won't they make better decisions? That's irrelevant for banks -- the question is whether they make
*more profitable*
decisions -- the degree to which a human is better needs to pay for their salary. Regardless of what you think of machine creditworthiness decisions, it's possible for them to underwrite a $10,000 credit line for literally pennies within seconds at 3 AM in the morning. This is one of the factors enabling the explosion of consumer credit over the last few decades.
As long as I'm on the topic: credit decisions were highly discriminatory in the human underwriter era. "Tom is a good Christian, of course he'll pay his debts... that black man, on the other hand, well..." Machines don't care and
*provably*
...
They're not so wonderful for
*retail*
justice -- individuals, as opposed to groups, can be substantially unjustly penalized on the basis of their credit scores if the CRA have inaccurate data about them. This is a very, very common problem -- not common enough to make banks lose money by relying on CRAs, but very common nonetheless.
