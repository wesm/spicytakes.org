---
title: "Alienating Atmosphere"
description: "There are many factors that lead to the troublingDiversityImbalancethat we find in the software   community. Some of these, like the problems in teenage education   that discourages girls fromSTEM sub"
date: 2014-02-11T00:00:00
tags: ["diversity", "internet culture"]
url: https://martinfowler.com/bliki/AlienatingAtmosphere.html
slug: AlienatingAtmosphere
word_count: 2291
---


There are many factors that lead to the troubling
  [DiversityImbalance](https://martinfowler.com/bliki/DiversityImbalance.html) that we find in the software
  community. Some of these, like the problems in teenage education
  that discourages girls from [STEM subjects](http://en.wikipedia.org/wiki/STEM_fields) is a long term problem
...
1: 
      ...
      Code](http://www.blackgirlscode.com) and [Technovation Challenge](http://iridescentlearning.org/programs/technovation-challenge/).


![](images/alienatingAtmosphere/sketch.png)
...
One of the hardest things about talking about this alienating
  ...
  many people in [HistoricallyDiscriminatedAgainst](https://martinfowler.com/bliki/HistoricallyDiscriminatedAgainst.html) populations it's a
  constant indication that âyou're not welcome hereâ.
...
One of the sharpest technologists I know is a woman who has been
  ...
  is different to hers, a little voice saying âthis place is not for
  youâ. If such a reaction still strikes someone as accomplished as
...
Physical attacks are rare, but [do sometimes happen](http://en.wikipedia.org/wiki/Rebecca_Schaeffer). Recent
      statistics in the US indicate that [2 per thousand women
      suffer rape or sexual abuse each year](http://www.bjs.gov/index.cfm?ty=pbdetail&iid=4594) (4 per thousand for
      younger women). Another [survey
      focusing on college women](http://www.bjs.gov/content/pub/pdf/fvsv9410.pdf) found 35 women per thousand per
      year suffered sexual victimization in college.


It's also important to note that the fear of an attack, even
      if irrational, is still a factor. As one reviewer commented âI once
      had a rather unpleasant experience with a male colleague, I
      spoke up and took a stand and pretty much held my own. But after
      that, I couldn't shake off the fear for days together, that he
      might turn around and physically harm me! This was probably the
      farthest thing from a possibility - but that thought was with me
      with an annoying amount of conviction. And every time I take a
      stand I feel a pinch of that.â


Someone can be very sure intellectually that there isn't a threat
      of a physical attack, yet the debilitating emotion is still there.
...
There's an important asymmetry here. I've occasionally been on
  ...
  âyour kind is not welcome hereâ.
...
A first start is just to be aware that different people will
  ...
  found useful [in the past](https://martinfowler.com/bliki/SmutOnRails.html) is
  **I can't choose whether someone is offended by my actions. I can
  choose whether I care.** If someone reacts in an hurt way to
  something I say, I don't get to say âyou can't be offended by thatâ.
  ...
  quantity has a big cumulative effect](http://www.apa.org/monitor/2009/02/microaggression.aspx).
...
![](images/alienatingAtmosphere/offence.png)


I do care, and think we as a profession should care, about this
  kind of thing with [HistoricallyDiscriminatedAgainst](https://martinfowler.com/bliki/HistoricallyDiscriminatedAgainst.html)
  groups. Correcting these long-term discriminations takes time, and
  can't be solved by just saying âwe're all equal nowâ. An alienating
...
3: 
      The [best study into this](http://www.nsvrc.org/publications/articles/false-reports-moving-beyond-issue-successfully-investigate-and-prosecute-non-s) that I could find indicated that false
...
But I agree with the notion that [**the standard you
  walk past is the standard you accept**](http://www.youtube.com/watch?v=QaqpoeVgr8U). Many women are [sick
  of complaining](http://www.jimchines.com/2013/08/sexual-harassment-conversations-in-comic-form/) about this kind of behavior because these
...
In particular we must avoid supporting this alienating
  ...
  incidents are told to âgrow a thick skinâ. I find this kind of
  support for [NetNastiness](https://martinfowler.com/bliki/NetNastiness.html) deeply annoying.


![](images/alienatingAtmosphere/skin.png)
...
Amanda Hess gives [a sad but worthwhile summary](http://www.psmag.com/navigation/health-and-behavior/women-arent-welcome-internet-72170) of attacks
...
Ashe Dryden writes about the [risks and
    rewards of speaking up](http://ashedryden.com/blog/the-risk-in-speaking-up) to oppose the alienating atmosphere in
    tech. The post includes responses to common misconceptions and suggestions
    of how to help.


Often it's seemingly tiny things that contribute to the
    alienating atmosphere - things that are just one droplet of miasma
    on their own, but form a big cloud when you run into them every day.
    Do read [Kat
    Hagan's excellent post describing them](http://notapattern.net/2014/10/14/ways-men-in-tech-are-unintentionally-sexist/). Derrick Clifton has a
    [similar piece](http://www.dailydot.com/opinion/clueless-things-white-people-say-racism/) on common reactions to racism.


Birgitta Böckeler [writes the frustrating story](https://martinfowler.com/articles/born-for-it.html) about how the modern image of programmers
    as anti-social males came about.
...
My thanks to Ashe Dryden, Adria Richards, Adrienne Hisbrook,
     Andrew Slocum, Chitra Sachdeva, Graham Brooks, Jim Gumbley, Linda
     Rising, Peter Gillard-Moss, Rebecca Parsons, and Trisha Gee for
