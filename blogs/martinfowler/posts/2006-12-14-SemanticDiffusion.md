...
description: "I have the habit of creatingNeologisms to describe the things I see in software development. It's a common habit amongst writers in this field, for software development still lacks much useful jargon."
date: 2006-12-14T00:00:00
tags: ["agile adoption", "dictionary", "bad things", "writing"]
url: https://martinfowler.com/bliki/SemanticDiffusion.html
slug: SemanticDiffusion
word_count: 1092
---


I have the habit of creating [Neologism](https://martinfowler.com/bliki/Neologism.html)s to describe
...
Semantic diffusion occurs when you have a word that is coined by a
...
I'm partly prompted to write this because I see this semantic
  ...
  two terms at the moment: 'agile' and '[Web2.0](https://martinfowler.com/bliki/Web2.0.html)'. Both were coined in the
  last few years and both come with lengthy definitions. (Agile has
  the [agile manifesto](http://agilemanifesto.org/),
  together with numerous books and [articles](https://martinfowler.com/articles/newMethodology.html) by
  the authors of the manifesto. Web 2.0 has an excellent [definitional
  article](http://www.oreillynet.com/pub/a/oreilly/tim/news/2005/09/30/what-is-web-20.html) by Tim O'Reilly.) Yet both of these face a lot of corruption
  ...
  about using AJAX. (A more personal case is [RefactoringMalapropism](https://martinfowler.com/bliki/RefactoringMalapropism.html),
  but I'll leave that aside for the moment.)


Semantic diffusion is essentially a succession of the [telephone game](https://en.wikipedia.org/w/index.php?title=Telephone_game)
  where a different group of people to the originators of a
...
to create the telephone chains.
...
people aren't careful to go back to the source, the telephone game
begins. Popular ideas also spread primarily though communication media
...
seventeen [âlet the ship
sailâ](https://martinfowler.com/articles/agileStory.html) to go its own way.) Let's not forget there's a tricky
...
A common form of semantic diffusion is when the term ends up meaning the
  *opposite* of what it was coined to describe. Such as âDevOpsâ turning
  into the name for a separated operations team or âMinimal Viable Productâ
  being used for a $12M first release. Holly Cummins neatly [coined](https://twitter.com/holly_cummins/status/1416040187889688582) âSemantic
  Inversionâ to describe this variant of concern.
