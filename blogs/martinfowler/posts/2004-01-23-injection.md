...
description: "In the Java community there's been a rush of lightweight containers that help to assemble components from different projects into a cohesive application. Underlying these containers is a common patter"
date: 2004-01-23T00:00:00
tags: ["design", "object collaboration design", "application architecture"]
...
service. But writing âcomponent or serviceâ is tiring to read and
...
text file called âmovies1.txtâ then everything is wonderful. If they
...
Figure 1 shows the dependencies for this
...
In my book [P of EAA](https://martinfowler.com/books/eaa.html), we
described this situation as a [Plugin](https://martinfowler.com/eaaCatalog/plugin.html). The
...
they implement âInversion of Controlâ I end up very puzzled. [Inversion
of control](https://martinfowler.com/bliki/InversionOfControl.html) is a common characteristic of frameworks, so saying that
...
The question is: âwhat aspect of control are they inverting?â
...
application program. You would have a sequence of commands like âEnter
nameâ, âenter addressâ; your program would drive the prompts and pick
...
In this case I'll use the ServiceLocator as a singleton [Registry](https://martinfowler.com/eaaCatalog/registry.html).
...
[role interface](https://martinfowler.com/bliki/RoleInterface.html). That way, instead of using the full service
...
public class MyMovieLister implements MovieLister, Serviceable {
    ...
    public void service( ServiceManager manager ) throws ServiceException {
        finder = (MovieFinder)manager.lookup(âfinderâ);
    } 
