---
title: "Rigorous Agile"
description: "I often run into a complaint that agile methods don't have a 	rigorous definition. The complainer may talk about how this means 	that you can't tell if a particular team is using an agile method or 	n"
date: 2005-05-29T00:00:00
tags: ["agile", "certification", "metrics"]
url: https://martinfowler.com/bliki/RigorousAgile.html
slug: RigorousAgile
word_count: 436
---
...
and highly variable](http://alistair.cockburn.us/Characterizing+people+as+non-linear%2c+first-order+components+in+software+development). The conclusion that agilists made from this
...
I can't deny that this is frustrating. How can you do a survey on
	...
	tell if it's really being done?. There is a sense of âI know it when
	I see itâ,  but it requires an
