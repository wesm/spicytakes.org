...
description: "The term 'Mock Objects' has become a popular one to 	describe special case objects that mimic real objects for 	testing. Most language environments now have frameworks that make it 	easy to create moc"
date: 2007-01-02T00:00:00
tags: ["testing"]
url: https://martinfowler.com/articles/mocksArentStubs.html
slug: mocksArentStubs
word_count: 5714
---


I first came across the term âmock objectâ a few years ago in the
[Extreme Programming](https://martinfowler.com/bliki/ExtremeProgramming.html) (XP) community. Since then I've run into mock objects more and more.
...
This difference is actually two separate differences. On the
		...
		classical and mockist styles of [Test Driven Development](https://martinfowler.com/bliki/TestDrivenDevelopment.html).
...
I referred to the SUT as the âprimary objectâ and collaborators as
âsecondary objectsâ)
...
When they were first introduced, many people easily confused
			...
			doubles. (âdoublesâ? Don't worry if this is a new term to you,
...
You sometimes see âDetroitâ style used for âclassicalâ and
      âLondonâ for âmockistâ. This alludes to the fact that XP was
...
With this style you begin developing a [user story](https://martinfowler.com/bliki/UserStory.html) by writing your first
...
these [Object Mothers](https://martinfowler.com/bliki/ObjectMother.html), based on a naming convention used on an early
...
One of the hardest things for people to understand in OO
			design is the [âTell Don't Askâ
			principle](https://martinfowler.com/bliki/TellDontAsk.html), which encourages you to tell an object to do
...
Mockists favor [role interfaces](https://martinfowler.com/bliki/RoleInterface.html) and assert that using
