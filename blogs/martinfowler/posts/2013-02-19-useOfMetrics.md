---
title: "An Appropriate Use of Metrics"
description: "Management love their metrics. The thinking goes something         like this, âWe need a number to measure how we’re doing.         Numbers focus people and help us measure success.â Whilst       "
date: 2013-02-19T00:00:00
tags: ["metrics", "productivity", "project planning", "technical leadership"]
url: https://martinfowler.com/articles/useOfMetrics.html
slug: useOfMetrics
word_count: 4274
---
...
> Tell
>         me how you measure me and I will tell you how I behave. 
> -- [Eliyahu Goldratt](https://www.amazon.com/gp/product/0884271951/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0884271951&linkCode=as2&tag=martinfowlerc-20)
...
2. Management establish a target over a large period (3-6 months up to a year) for the people doing
                        the work
...
A test manger, let’s call her Mary, holds weekly meeting with the development lead, Dan. âWhere are
                we at with our bug counts?â she asked at their most recent one. Dan answered, âWe cleared our
                three priority one bugs, fixed four priority two bugs and cleared out a record twelve priority three
                bugs. A pretty good week right?â


Looking at the development lead, slightly shaking her head, Mary responded, âUnfortunately our
                customer reported five priority one bugs, six priority two bugs and fifteen priority three bugs. You’ll
                need to work harder next week.â Exasperated and feeling overwhelmed at missing his target, Dan left
...
Dan is experiencing single loop learning1.
                ...
                seems to fit well here: âdoing the same thing over and over again and expecting different results.â


1: 
            Chris Arygris & Donald A. Schön describes the concepts of single-loop and double-loop learning in their book [Organizational Learning: A theory of action perspective](https://www.amazon.com/gp/product/0201001748/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0201001748&linkCode=as2&tag=martinfowlerc-20).
...
Even agile techniques do not protect teams from the undesirable behaviors driven by measuring and
                tracking the wrong number. For example, agile teams often use story cards2
...
2: 
            As described in [User Stories Applied: For Agile Software Development](https://www.amazon.com/gp/product/0321205685/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0321205685&linkCode=as2&tag=martinfowlerc-20)


![](useOfMetrics/metrics-cardwall.png)


Figure 1: Example of a storywall


Management and product management often ask the question, âHow soon will that feature be complete?â
                ...
                reinforces this perception by asking the question, âHow many stories did we finish coding this
                week?â instead of the better question, âHow many stories are we happy to release to end users?â or
                better yet, âHow many stories did we release to end users?â An even better question is, âHow much value
                have our users found from our recent releases?â


Teams want to do the right thing and these questions and metrics consequently drive developers to focus
                on getting stories*Development Complete*. Let’s look at the consequences of overtly focusing on
...
Malcolm, a marketing representative always takes a keen interest in what developers built for him that he
                ...
                think to himself, âThis feature must be really important.â Tim, the team's newest tester often needed to
                approach a developer, like Dan, to understand how to trigger the newly developed features.


Tim approaches Dan one day, âHi Dan! I really need your help to understand how to test this feature
                you completed last week.â Dan, under pressure to deliver snaps, âCan't you do anything by
                yourself? I need to get this feature complete so Malcolm gets off my back.â Shocked at Dan's
                response, Tim returns to his desk, and waits. He thinks to himself, âI can't get anything done
                until Dan helps me out.â
...
Each week this happens, and over time, the stack of stories waiting to be tested grows and grows.
                ...
                âI couldn't test that story because I needed some help from Dan and he's been so busy with other
                work. I didn't want to interrupt him.â
...
What can we learn from this story? Firstly, what matters to Malcolm is that the flow of work is getting
                ...
                *Explicit Work in Progress*
                ...
                Software Development](https://www.amazon.com/gp/product/0321150783/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0321150783&linkCode=as2&tag=martinfowlerc-20), stresses the importance of measuring the end to end result instead of
...
Management find metrics too hard to resist because it distils down organizational complexity into
                    ...
                    to communicate when a target is met. âJust reach this number and we’ll be fineâ.
...
A consequence of revisiting metrics after long periods is that the failure to meet management’s
                    arbitrary target becomes more and more unacceptable. I’ve heard managers say things like, âYou
                    had a whole year to meet your target and you missed it.â The risk and cost of failure increases
...
Project post-mortems look back after a project finished, seeking lessons learned in the hope of
                    ...
                    [Agile Retrospectives](https://www.amazon.com/gp/product/0977616649/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0977616649&linkCode=as2&tag=martinfowlerc-20)
...
You can look for some symptoms for potentially out-dated metrics by asking people, âWhy do we
                    need to collect this number?â A terrible response might include, âThat’s the way we’ve
                    always done it,â or worse yet, âIt’s our policy.â This question does not necessarily
