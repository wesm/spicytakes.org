...
description: "Domain-Driven Design is an approach to software development that centers   the development on programming a domain model that has a rich understanding of   the processes and rules of a domain. The nam"
date: 2020-04-22T00:00:00
tags: ["evolutionary design", "domain driven design", "application architecture"]
...
Eric Evans's great contribution to this, through his book, was developing a
  ...
  complex domain, we need to build [Ubiquitous Language](https://martinfowler.com/bliki/UbiquitousLanguage.html) that
  ...
  proponent of [Extreme Programming](https://martinfowler.com/bliki/ExtremeProgramming.html) and sees Domain-Driven
...
The book introduced the notion of classifying objects into Entities, Value
  Objects, and Service Objects - what I call the [Evans Classification](https://martinfowler.com/bliki/EvansClassification.html) and identifying the concept of [Aggregates](https://martinfowler.com/bliki/DDD_Aggregate.html). I found these filled an important
  ...
  Strategic Design - how to organize large domains into a network of [Bounded Contexts](https://martinfowler.com/bliki/BoundedContext.html). Until that point, I'd not seen anyone
