...
description: "You're sitting in a meeting, contemplating the code that your   team has been working on for the last couple of years. You've come   to the decision that the best thing you can do now is to throw away"
...
![](images/sacrificialArchitecture/sketch.png)
...
1: 
      As [Jeff Dean puts it](http://static.googleusercontent.com/media/research.google.com/en//people/jeff/WSDM09-keynote.pdf) âdesign for ~10X growth, but plan to
      rewrite before ~100Xâ
...
Indeed it's a common pattern to see people coming into a maturing
  ...
  phrase âperformance is a featureâ, which some people read as saying
