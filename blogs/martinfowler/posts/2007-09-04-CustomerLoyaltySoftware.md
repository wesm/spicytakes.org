...
description: "I was in the Calgary office last week and had a good chat with 	John Kordyback, one of our most trusted technical leads. He's worked 	on, and dug into, a number of travel loyalty software systems 	(fr"
date: 2007-09-04T00:00:00
tags: ["domain driven design"]
url: https://martinfowler.com/bliki/CustomerLoyaltySoftware.html
slug: CustomerLoyaltySoftware
word_count: 1063
---


I was in the Calgary office last week and had a good chat with
	...
	kinds of things and how to think about them in a more fruitful manner.


The core of of a loyalty system is a system to keep track of
...
accounting spectacles on.


An example of this is dealing with ad-hoc changes. However good
...
for this](https://martinfowler.com/eaaDev/AccountingNarrative.html) are well understood.


A notable difference between a loyalty program and most accounting
...
Many loyalty systems have multiple kinds of points, such as  such
...
these easily as multiple currencies.


An interesting twist on this is potential points. If I book a
	...
	just have to apply the model to the situation.


We fleshed this out in practice where we also found it really
	helpful to use [TestDrivenDevelopment](https://martinfowler.com/bliki/TestDrivenDevelopment.html). A group of people
...
The accounting analogy also applies, although partly less
...
Dispatchers](https://martinfowler.com/eaaDev/AgreementDispatcher.html). This is a pattern John and I have used lots of times
...
The second aspect of a loyalty system is tracking the customer
...
Like me, John is a strong proponent of using [ReportingDatabases](https://martinfowler.com/bliki/ReportingDatabase.html),
	...
	not necessarily real time, feeds from the accounting side.


Taking it further, it seems reasonable to completely decouple the
	...
	generate some events for the customer experience side too).


One of the habits of customer experience tracking is frequent
	...
	and thus easier to build.


As you can see, our discussion did shift from looking at John's
