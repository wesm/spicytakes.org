---
title: "Diversity Mediocrity Illusion"
description: "I've often been involved in discussions about deliberately   increasing the diversity of a group of people. The most common case   in software is increasing the proportion of women. Two examples are  "
date: 2015-01-13T00:00:00
tags: ["diversity"]
url: https://martinfowler.com/bliki/DiversityMediocrityIllusion.html
slug: DiversityMediocrityIllusion
word_count: 1690
---
...
![](images/diversityMediocrityIllusion/sketch.png)
...
When interviewing, we make a point of ensuring there are women
  ...
  ensure we don't have the same [AlienatingAtmosphere](https://martinfowler.com/bliki/AlienatingAtmosphere.html) that
...
One anecdote that stuck in my memory was from a large,
  ...
  women on the list of candidates. (Something like: âthere must be at
  least three credible women candidates for each postâ.) This
...
For conference planning it's a similar strategy:  just putting out a call for
  ...
  is a good example](http://continuousdelivery.com/2013/09/how-we-got-40-female-speakers-at-flowcon/) of a conference that made this an explicit
  goal and did far better than the industry average (and in case you
  were wondering, there was [no
  difference between men's and women's evaluation scores](http://continuousdelivery.com/2013/12/flowcon-2013-wrap-up/)).
...
So now that we recognize that getting greater diversity is a
  ...
  argued that it is, because our [DiversityImbalance](https://martinfowler.com/bliki/DiversityImbalance.html) is
  ...
  [HistoricallyDiscriminatedAgainst](https://martinfowler.com/bliki/HistoricallyDiscriminatedAgainst.html) groups.
...
Conferences have an important role to play in correcting this
  ...
  guys like me, then that adds to the [AlienatingAtmosphere](https://martinfowler.com/bliki/AlienatingAtmosphere.html)
...
For companies, the choice is more personal. For me,
  Thoughtworks's [efforts to improve its diversity](https://www.thoughtworks.com/news/2016-top-companies-for-women-technologists) are a major factor
...
But I'm not holding Thoughtworks up as an example of perfection.
  ...
  is look at our [Technical Advisory Board](http://www.thoughtworks.com/radar/faq)
...
Despite my knowledge of how far we still have to climb, I can
  ...
  as the sole male during a late night game of [Dominion](https://martinfowler.com/articles/eurogames/), I enjoyed a
...
We've worked hard at Thoughtworks to improve our diversity. Our [Top Company for Women Technologists](https://www.thoughtworks.com/news/2016-top-companies-for-women-technologists) award outlines some of the
  data behind this, Sam Newman talks in detail about [some of the
  measures](http://samnewman.io/blog/2016/08/22/tips-on-hiring-more-women-from-a-man/) we took to get there. Yewande Ige gives a [talk to recruiters about our
  change](https://www.youtube.com/watch?v=WRXkswGT2bw) - an important point is probing majority candidates for their openness to having
  their opinions challenged about diversity.


Atlassian describe how they [increased their female technical hires by 80%](http://firstround.com/review/atlassian-boosted-its-female-technical-hires-by-80-percent-heres-how/).
