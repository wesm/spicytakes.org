...
description: "There's been a few posts over the last couple of months aboutTechnicalDebtthat's raised the question of what kinds of design   flaws should or shouldn't be classified as Technical Debt."
date: 2009-10-14T00:00:00
tags: ["technical debt"]
url: https://martinfowler.com/bliki/TechnicalDebtQuadrant.html
slug: TechnicalDebtQuadrant
word_count: 842
---


There's been a few posts over the last couple of months about
  [TechnicalDebt](https://martinfowler.com/bliki/TechnicalDebt.html) that's raised the question of what kinds of design
  flaws should or shouldn't be classified as Technical Debt.


A good example of this is Uncle Bob's post saying [a
  mess is not a debt](https://sites.google.com/site/unclebobconsultingllc/a-mess-is-not-a-technical-debt). His argument is that messy code, produced by
...
Reckless debt may not be inadvertent. A team may know about good
  ...
  go âquick and dirtyâ because they think they can't afford the time
  ...
  [DesignPayoffLine](https://martinfowler.com/bliki/DesignPayoffLine.html) is. The whole point of good design and
...
I hear this all the time from the best developers. The point is
  ...
  about in [his
  video](http://www.c2.com/cgi/wiki?ComplexityAsDebt).
