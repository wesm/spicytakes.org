...
description: "â'War and Peace' is a wonderful book."
date: 2007-01-11T00:00:00
tags: ["domain driven design"]
url: https://martinfowler.com/bliki/TypeInstanceHomonym.html
slug: TypeInstanceHomonym
word_count: 1152
---


> â'War and Peace' is a wonderful book.
> âLet me see... pity this book has such a tattered coverâ
...
have a close relationship 1. A book [PhysicalCopy] carries on it a
...
1: 
      ...
      term âpolysemyâ is sometimes used to indicate a word
...
homonyms in your domain language, it's often because the terms are
	...
	Evans calls Bounded Contexts. As Jim Odell liked to point out: âMary
	had a little lambâ means quite different things to a veterinarian than
...
My purpose here isn't to talk much further about modeling these
	...
	property, as the phrase âgo through the door we painted last
	weekâ suggests.)
...
There's a particularly fascinating case of this in my own
	...
	âadd a method to an objectâ. Yet, of course, we don't add methods to
...
So what does this mean in the context of a
	[UbiquitousLanguage](https://martinfowler.com/bliki/UbiquitousLanguage.html)? Firstly we have to do the modeling
	...
	bare homonym: so I wouldn't use âbookâ in the library context,
	...
	the new terms. So if a domain person says âa book has authorsâ we
	might say âyou mean a literary work there, right?â Remember that it
