---
title: "Value Object"
description: "When programming, I often find it's useful to represent things as a compound. A   2D coordinate consists of an x value and y value. An amount of money   consists of a number and a currency. A date ran"
...
1: 
      In Domain-Driven Design the [Evans Classification](https://martinfowler.com/bliki/EvansClassification.html) contrasts value
      objects with entities. I consider entities to be a common form of reference object,
      but use the term âentityâ only within domain models while the reference/value object
...
This is an example of an [Aliasing Bug](https://martinfowler.com/bliki/AliasingBug.html), I change a date in one place
  ...
  immutable**. If I want to change my party date, I create a new
  object instead.
...
5: 
      ...
      If I was concerned that a team wouldn't be disciplined enough I might use
...
6: 
      There is more discussion of this in [Evans's DDD book](https://www.amazon.com/gp/product/0321125215/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0321125215&linkCode=as2&tag=martinfowlerc-20).
...
I find that value objects, particularly small ones, are often overlooked - seen as
  ...
  [Range class](https://martinfowler.com/eaaDev/Range.html) and see how it prevents all sorts of duplicate
...
Vaughn Vernon's description is probably the [best in-depth
    discussion of value objects](https://www.amazon.com/gp/product/0321834577/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0321834577&linkCode=as2&tag=martinfowlerc-20) from a DDD perspective. He covers how to decide
...
The term started gaining traction in the early noughties. Two books that talk about
    them from that time are [PoEAA](https://martinfowler.com/books/eaa.html) and [DDD](https://www.amazon.com/gp/product/0321125215/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=0321125215&linkCode=as2&tag=martinfowlerc-20). There was also some interesting discussion on [Ward's Wiki](http://c2.com/cgi/wiki?ValueObject).


One source of terminological confusion is that around the turn of the century some
    J2EE literature used âvalue objectâ for [Data Transfer Object](https://martinfowler.com/eaaCatalog/dataTransferObject.html). That usage has
