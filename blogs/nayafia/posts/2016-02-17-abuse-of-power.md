...
Apple’s fear is that working with the FBI in this case would set a precedent for other, more ambiguous reasons to bypass security, such as surveillance or tracking. (This is the broader concern about so-called “[security backdoors](https://en.wikipedia.org/wiki/Backdoor_%28computing%29)”.)


An [open letter](https://www.apple.com/customer-letter/) posted on their website explained:
...
In past decades, we saw government as a steward of our best interests, enforced by checks and balances. But the government was never objective or neutral. (We put the [Three-Fifths Compromise](https://en.wikipedia.org/wiki/Three-Fifths_Compromise) into the U.S. Constitution, for goodness’ sakes.) Governments are made of people, and people are subject to the same cultural norms, influences and temptations as the rest of us.
...
*(The title of this post comes from artist [Jenny Holzer](https://twitter.com/jennyholzer), which rings in my head every so often.)*


*([Cross-posted from Medium](https://medium.com/@nayafia/abuse-of-power-comes-as-no-surprise-bb2ab9b64a02).)*
