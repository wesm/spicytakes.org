...
My first reaction was to wrinkle my nose. His comment reminded me of the NIMBY-ish attitudes of urban dwellers who complain about newcomers moving in and “ruining” their neighborhoods. I generally believe that people, interests, and potential kinships are unevenly distributed by geography. Cities are living organisms, and changing demographics is part of what makes them beautiful.


*Portland to San Francisco: “Go back to California” [Via SF Gate / The Oregonian](https://www.sfgate.com/news/article/Portland-California-graffiti-frustration-11262678.php)*
...
While some communities haze their newcomers, others resist being defined at all. Ribbonfarm’s Venkatesh Rao, for example, frequently [downplays the term ‘postrationalist’](https://twitter.com/vgr/status/1041075485273255936) as well as the very idea of [fostering a community](https://twitter.com/mandalaeyes/status/1140415500830281728) around it, despite the fact that many people are clearly attracted to the same watering hole. I tend to interpret this dismissiveness as a way of saying, *“We don’t want to become a ‘thing’ because ‘things’ are destroyable by outsiders.”* Avoiding labels is a way of keeping hidden cities away from the colonizers, like a nomadic tribe on the move.
...
I kept going back. I was even delighted to share my discovery with a few appreciative friends. But then Bon Appetit [published an article](https://www.bonappetit.com/story/best-bakeries-2016) declaring Arsicault one of the “best new bakeries” in America, and just like that, our secret was gone. For the next two years, the lines were always out the door. The staff had to impose limits upon how many pastries a customer could order. I stopped going until the crowds subsided.


The difference between a bakery and an internet subculture is that one makes croissants and the other makes ideas. As far as I can tell from public information, [the press was good](https://sf.eater.com/2018/10/11/17963350/arsicault-bakery-sf-expanding-new-second-location) for Arsicault. It turns out they had only opened a year before, and all the public attention helped them open up a second location.  More customers, under the right circumstances, means more capital to expand operations. The crazy lines eventually died down to a more manageable wait, too.
...
1. Name omitted, of course, to protect the undiscovered. ↩
2. Lest this require clarification, I’m not condoning hostility towards newcomers, but trying to understand where it comes from. I think it’s possible to expect that newcomers demonstrate skin in the game, without being rude or unkind towards them. ↩
3. I’m convinced that “backpacker culture” arose not just from shared values, but out of necessity, as being forced into the same closed quarters, and traversing the same paths, creates a new meta-culture that displaces the authentic. ↩
