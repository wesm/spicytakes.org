...
I recently read Elinor Ostrom’s [Governing the Commons](https://www.amazon.com/dp/B015WJ1C8W/) and have been evangelizing it so enthusiastically that I figured I’d do a quick writeup of its main points, and why it’s been so transformative to my thinking.
...
But secondly, maybe her time hadn’t yet come. We’re entering a period where people are distrustful of institutions, where [decentralization is the rally-cry](https://twitter.com/kanyewest/status/989184815340535808). Maybe now is the time to cast aside the market and the state as our saviors, and instead consider an alternative: one that recognizes the ability of people to organize and design solutions for themselves.


*([Cross-posted from Medium](https://medium.com/@nayafia/an-alternate-ending-to-the-tragedy-of-the-commons-446b4e960887).)*
