...
I’m thrilled about the [launch of GitHub Sponsors](https://github.com/sponsors), which signals a strong commitment from GitHub to support financial infrastructure and tooling for developers. It’s arguably the biggest open source funding experiment to date and will create plenty of opportunities to learn from.
...
Recently however, as I’ve been simultaneously digging into the world of Twitch streamers [1], I’ve begun to wonder: *“What would a viable, standalone strategy for user-to-user sponsorships look like?”* So I thought that would be fun to explore here. [2] My hypothesis: rather than individual sponsorships being a path to company sponsorships, the motivations of individuals are different from companies, and therefore should be treated as two separate use cases, and two separate products.
...
*Followers: that odd little number at the top of your [GitHub profile](https://github.com/nayafia).*
...
There are some negative implications to framing individual sponsorships this way. Emphasizing the performative aspect would further push the idea of “celebrity developers”, which some types of open source work are just not as well-suited for. For example, JavaScript seems to have stronger social status dynamics than other languages. However, I suspect that in every open source ecosystem, there are newer developers who want to “watch and learn” from experienced ones, and GitHub is capable of connecting those people to each other.
...
1. Note: I am not an expert on Twitch streamers; merely a casual connossieur. ↩
2. A few disclosures that feel relevant here: I worked at GitHub from 2016-2018, and I also have a (small) financial stake in Open Collective. ↩
3. Prominent GitHub developers could also include those who aren’t primarily known for their open source work. [Julia Evans](https://github.com/jvns), for example, creates a lot of useful programming content and has 4.8K followers. ↩
