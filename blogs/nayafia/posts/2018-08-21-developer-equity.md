...
date: 2018-08-21
url: https://nadia.xyz/developer-equity
word_count: 735
---
...
I’ve been mulling on Handshake, a new DNS service [that recently announced](https://www.coindesk.com/handshake-revealed-vcs-back-plan-to-give-away-100-million-in-crypto/) their intent to give away 70% of their value to developers.


From [their paper](https://handshake.org/files/handshake.txt) (emphasis mine):
...
Far from altruistic, by giving away ownership to incentivize development, Handshake seems like a better version of the “developer funds” offered by platforms like [Slack](https://slack.com/developers/fund), [Facebook](https://developers.facebook.com/fbstart/), or [Cloudflare](https://www.cloudflare.com/fund/).
...
I could see this being beneficial not just for developers, but for the platform itself. Equity awards are likely simpler and cheaper than [acquiring popular apps](https://www.theverge.com/2016/10/28/13456208/why-vine-died-twitter-shutdown) and [shutting them down](https://www.pcworld.com/article/2030075/tweetdeck-shutdown-gives-a-glimpse-of-twitters-future.html). And rewarding the most popular third-party developers with small amounts of equity could take the pain out of unfavorable policy changes that platforms inevitably must make later down the line.
...
Platform-developer relationships today resemble a political battle more than a dance. Twitter is an example of a platform with [a long, contentious relationship](https://nordicapis.com/twitter-10-year-struggle-with-developer-relations/) with its third-party developers, historically limiting access to its APIs and [making major changes](https://www.theverge.com/2018/4/6/17206524/twitter-tweetbot-twitterrific-apps-features-api-changes) that threaten the future of apps in its ecosystem. Last week, Rob Johnson, a product director at Twitter, [finally announced their decision](https://twitter.com/robjohnson/status/1030122316875747328?s=21) to officially end support for legacy APIs, “acknowledging that some aspects of these [3rd party] clients will be degraded as a result”.
...
*Thanks to [Feross](https://twitter.com/feross) for an email conversation that nudged this post.*


[1] Kin’s [Developer Program](https://medium.com/kinblog/kin-developer-program-launches-today-f4f2822d4cf2) seems to take this approach, offering $60K + 400M Kin for building on their ecosystem.
