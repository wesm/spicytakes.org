...
This week, Chris Dixon [voiced a concern](https://medium.com/tweet-stormed/proprietary-services-vs-open-protocols-4ab867b0eeb7) many of us feel for the future of technology: that in the battle of proprietary services (like AOL or Facebook) vs. open protocols (like HTTP or SMTP), we’re currently on the wrong side of history. This topic is timely for those watching the story unfold between Meerkat and Periscope (which was recently acquired by Twitter).


Ev Williams’ response was that [“sometimes things stay stuck”](https://medium.com/@ev/sometimes-things-stay-stuck-a0796cc638a3), pointing to radio, television, music and movies as examples of industries that were catalyzed by openness and innovation before eventually settling into a closed and centralized system. What, he asks, could push things in the other direction?
...
- **Patronage:** More and more people are interested in patronage as a viable form of monetization, from [Patreon](https://www.patreon.com/) to [YouTube stars](https://medium.com/@hankgreen/the-1-000-cpm-f92717506a4b) to [Google](https://contributor.google.com/v/beta). If successful, patronage could wean more creators off of centralized platforms.
