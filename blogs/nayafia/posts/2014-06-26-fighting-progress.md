...
Society at the time was infatuated with food processing. The sentiment of the time was the triumph of man over nature through science, and artificial food fit right in. 1960s and 1970s science fiction is [littered with references](http://io9.gizmodo.com/5908332/remember-when-we-thought-wed-get-all-our-nutrition-from-pills) to meal replacement pills and cubes, with even Pillsbury developing and selling Space Food Sticks.


([Image source](http://www.npr.org/2007/06/07/10792763/beyond-tang-food-in-space))


Yet, by the 1980s, we started to realize that we didn’t really want to eat artificial food all the time. In fact, the trend began moving towards [slow food](https://en.wikipedia.org/wiki/Slow_Food) and [local produce](https://en.wikipedia.org/wiki/Local_food). We discovered there was intrinsic value, both mental and physical, in eating a meal prepared from fresh ingredients.


We had the technology to do away with food, but we decided not to.


Today, there is a surprising lack of conversation about the societal implications of big data, advertising and privacy. We love the idea of adding a data-driven curation layer onto everything. We want data to recommend to us what we should read, what we should wear, what we’re searching for online. We don’t even mind advertisers using our data to help serve us more relevant ads. *“The thing that we have heard from people is that they want more targeted advertising,“* [insists Facebook](https://www.nytimes.com/2014/06/13/technology/facebook-to-let-users-alter-their-ad-profiles.html?_r=0).


There have been some ominous rumbles from activists about the [“filter bubble”](https://www.ted.com/talks/eli_pariser_beware_online_filter_bubbles) and [“becoming a gadget”](https://www.amazon.com/dp/0307389979/ref=asc_df_03073899795113708?smid=ATVPDKIKX0DER&tag=shopzilla0d-20&ascsubtag=shopzilla_rev_515-20;15031873528220599131910080301008005&linkCode=df0&creative=395093&creativeASIN=0307389979), but even the NSA scandal couldn’t unlock a civilian uprising. And maybe that’s because we’re still in the infatuation phase, basking in the glow of a screen that knows exactly who we are and what we want, food scientists gazing blissfully upon our glorious, jiggling Jell-O molds.
