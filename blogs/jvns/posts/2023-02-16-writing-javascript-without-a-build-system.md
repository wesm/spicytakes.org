...
slug: writing-javascript-without-a-build-system
word_count: 1318
---
...
I want to give a quick shoutout to esbuild: I [learned about esbuild in 2021](https://jvns.ca/blog/2021/11/15/esbuild-vue/) and used for a project, and
...
[Here’s a tiny template I built](https://github.com/jvns/vue3-tiny-template)
...
But – it seems like you can’t use CodeMirror 6 without a build system (according to [the migration guide](https://codemirror.net/docs/migration/)). So I’m going to stick with CodeMirror 5.


Similarly, you used to be able to just download Tailwind as a giant CSS file,
but [Tailwind 3](https://tailwindcss.com/docs/installation) doesn’t seem to be available as a
...
- use [https://unpkg.com](https://unpkg.com) to see if the library has a built version I can use
