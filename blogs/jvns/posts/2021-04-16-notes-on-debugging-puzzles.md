...
date: 2021-04-16
url: https://jvns.ca/blog/2021/04/16/notes-on-debugging-puzzles/
slug: notes-on-debugging-puzzles
word_count: 2387
---
...
- [The Case of the Slow Website](https://mysteries.wizardzines.com/slow-website.html)
...
4. Tells you the “correct” interpretation of the output and shows you how you
...
![](https://jvns.ca/images/newinfo.png)
...
![](https://jvns.ca/images/sidebar-mystery.png)
...
![](https://jvns.ca/images/textboxes.png)
...
You can see all of the source code for The Case of the Connection Timeout in [connection-timeout.twee](https://github.com/jvns/twine-stories/blob/2914c4326e3ff760a0187b2cfb15161928d6335b/connection-timeout.twee) and [common.twee](https://github.com/jvns/twine-stories/blob/2914c4326e3ff760a0187b2cfb15161928d6335b/common.twee), which has some shared code between all the games.


A few notes about using Twine:

- I’m using SugarCube, the [sugarcube docs are very good](https://www.motoslave.net/sugarcube/2/docs/)
- I’m using [tweego](https://www.motoslave.net/tweego/) to translate the `.twee` files in to a HTML page. I started out using the visual Twine editor to do my editing but switched to `tweego` pretty quickly because I wanted to use version control and have a more text-based workflow.
...
- The [Twine wiki](https://twinery.org/wiki/) and forums have a lot of great information and between the Twine wiki, the forums, and the Sugarcube docs I could pretty easily find answers to all my questions.


I used pretty much the exact Twine workflow from Em Lazerwalker’s great post [A Modern Developer’s Workflow For Twine](https://dev.to/lazerwalker/a-modern-developer-s-workflow-for-twine-4imp).
...
1. help people learn about **tools** (like tcpdump, dig, and curl). How do you use each tool? What questions can they be used to answer? How do you interpret their output?
