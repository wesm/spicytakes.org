---
title: "An attempt to make a font look more handwritten"
date: 2020-08-08
url: https://jvns.ca/blog/2020/08/08/handwritten-font/
slug: handwritten-font
word_count: 979
---
...
[iFontMaker](https://2ttf.com/). They pitch
...
here!](http://bangbangcon.com/recordings.html)) and saw this talk by Tristan
...
- a live demo: [Numderline Test](https://thume.ca/numderline/)
- the blog post: [Commas in big numbers everywhere: An OpenType adventure](https://blog.janestreet.com/commas-in-big-numbers-everywhere/)
- the talk: [!!Con 2020 - Using font shaping to put commas in big numbers EVERYWHERE!! by Tristan Hume](https://www.youtube.com/watch?v=Biqm9ndNyC8)
- the github repo: [https://github.com/trishume/numderline/blob/master/patcher.py](https://github.com/trishume/numderline/blob/master/patcher.py)
...
The best documentation I found for OpenType was this [OpenType™ Feature File Specification](https://adobe-type-tools.github.io/afdko/OpenTypeFeatureFileSpecification.html) reference. There are a lot of examples of cool things you can do in there, like replace “ffi” with a ligature.
...
[font-mixer](https://github.com/jvns/font-mixer/). It’s like 33 lines of code and I think it’s pretty straightforward. (it’s all in `run.sh` and `combine.py`)
...
![](https://jvns.ca/images/font-mixer-comparison.png)


And here’s a sample of the same text actually written by hand:


![](https://jvns.ca/images/handwriting-sample.jpeg)
