...
slug: possible-reasons-8-bit-bytes
word_count: 2684
---
...
There aren’t any definitive answers in this post, but I asked [on Mastodon](https://social.jvns.ca/@b0rk/109976810279702728) and
...
bits on x86-64). But according to section 4.1 (“Fundamental Data Types”) of the [Intel architecture manual](https://www.intel.com/content/www/us/en/developer/articles/technical/intel-sdm.html),
...
[Intel 8008](https://en.wikipedia.org/wiki/Intel_8008), which was built to be
...
[This Datapoint 2200 manual from the Computer History Museum](https://archive.computerhistory.org/resources/text/2009/102683240.05.02.acc.pdf)
...
that there’s a great explanation in the Wikipedia article on [36-bit computing](https://en.wikipedia.org/wiki/36-bit_computing):
...
In the 60s, there was a popular integer encoding called binary-coded decimal (or [BCD](https://en.wikipedia.org/wiki/Binary-coded_decimal) for short) that
...
![](https://upload.wikimedia.org/wikipedia/commons/a/ad/IBM-650-panel.jpg)
...
I’ve definitely never used it except as a fun fact (it’s such a fun word!). The Wikipedia article on [nibbles](https://en.wikipedia.org/wiki/Nibble) supports this theory:
...
And historically there have definitely been lots of machines that used byte sizes that weren’t powers of 2, for example (from [this retro computing stack exchange thread](https://retrocomputing.stackexchange.com/questions/7937/last-computer-not-to-use-octets-8-bit-bytes)):
...
indicate which bit. x86 doesn’t seem to do this, but the [Z80’s bit testing instructions](http://www.chebucto.ns.ca/~af380/z-80-h.htm) do.
- someone mentioned that some processors use [Carry-lookahead adders](https://en.wikipedia.org/wiki/Carry-lookahead_adder), and they work
...
1. It’s a waste of space – a byte is the minimum unit you can address, and if
...
Someone pointed out that [page 65 of this book from 1962](https://web.archive.org/web/20170403014651/http://archive.computerhistory.org/resources/text/IBM/Stretch/pdfs/Buchholz_102636426.pdf)
