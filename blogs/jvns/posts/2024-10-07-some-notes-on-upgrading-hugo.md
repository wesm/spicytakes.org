...
slug: some-notes-on-upgrading-hugo
word_count: 2208
---
...
[ad705aac064](https://github.com/gohugoio/hugo/commit/ad705aac0649fa3102f7639bc4db65d45e108ee2)
...
ended up hacking together a bash script to [download all of the changelogs from github as text files](https://gist.github.com/jvns/dbe4bd9271a56f1f8562bfe329c2aa9e), which I
...
that the new renderer (goldmark) uses the [CommonMark markdown standard](https://commonmark.org/), which I’m hoping will be somewhat
...
markers. [Here’s a reference in CommonMark for this](https://spec.commonmark.org/0.29/#example-263).
...
for various markdown snippets, [here it is in a gist](https://gist.github.com/jvns/9cc3024ff98433ced5e3a2304c5fc5e4).
...
I [asked on Mastodon](https://social.jvns.ca/@b0rk/113260718682453232) if
...
[stability as a core goal](https://www.11ty.dev/blog/stability/).
...
Overall I’ve been happy with Hugo – I [started using it](https://jvns.ca/blog/2016/10/09/switching-to-hugo/) because it had fast
...
Also I’m still using Hugo 0.54 for [https://wizardzines.com](https://wizardzines.com) so maybe these notes
