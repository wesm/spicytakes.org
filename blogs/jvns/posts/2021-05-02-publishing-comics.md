---
title: "I put all of my comics online!"
date: 2021-05-02
url: https://jvns.ca/blog/2021/05/02/publishing-comics/
slug: publishing-comics
word_count: 600
---


Hello! As you probably know, I write a lot of comics about programming, and I publish collections of them as zines you can buy at [https://wizardzines.com](https://wizardzines.com).
...
`socat`, you can [search twitter](https://twitter.com/search?q=socat%20from%3Ab0rk&src=typed_query&f=live)
...
couple of [pages](https://wizardzines.com/comics/kubernetes-components/) about [Kubernetes](https://wizardzines.com/comics/scenes-from-kubernetes/) I wrote one time that will probably never
make it into a zine either.


If someone wants to see the page on socat, I’d really like them to just be able to find it at [https://wizardzines.com/comics/socat](https://wizardzines.com/comics/socat)


### now they’re all online in one place!


the tl;dr is that (almost) all of my comics are now online in one place at [https://wizardzines.com/comics](https://wizardzines.com/comics). Hooray!
...
search using [list.js](https://listjs.com/). Here’s what it looks like.


![](https://jvns.ca/images/dns-search.png)
...
- the comics from [https://drawings.jvns.ca](https://drawings.jvns.ca)
- any other pages I’ve posted over the years on Twitter that aren’t in a zine,
assuming that I can find them (for example [scenes from distributed systems](https://tweets.jvns.ca/b0rk/status/1056560207562711041))
