...
date: 2022-11-06
url: https://jvns.ca/blog/2022/11/06/making-a-dns-query-in-ruby-from-scratch/
slug: making-a-dns-query-in-ruby-from-scratch
word_count: 2826
---


Hello! A while back I wrote a post about [how to write a toy DNS resolver in Go](https://jvns.ca/blog/2022/02/01/a-dns-resolver-in-80-lines-of-go/).
...
final program is
[dig.rb](https://gist.github.com/jvns/1e5838a53520e45969687e2f90199770) if you want to skip the explanations and just read some code.)
We won’t
...
2. In a different terminal tab, run [this Ruby program](https://gist.github.com/jvns/aa202b1edd97ae261715c806b2ba7d39) (`ruby dns-1.rb`)
...
Wireshark (or read [RFC 1035](https://datatracker.ietf.org/doc/html/rfc1035#section-4.1.1)), you’ll see
...
[The documentation for `.pack` is here](https://ruby-doc.org/core-3.0.0/Array.html#method-i-pack), and it says that `n` means
...
it](https://wizardzines.com/comics/little-endian/))
...
[Here’s all the code we’ve written before in `dns-2.rb`](https://gist.github.com/jvns/3587ea0b4a2a6c20dcfd8bf653fc11d9) –
...
If you want to read more about DNS compression, I found the [explanation in the DNS RFC](https://datatracker.ietf.org/doc/html/rfc1035#section-4.1.4) relatively readable.
...
smarter and deal with that. For example [here’s the code that avoids infinite loops in miekg/dns](https://github.com/miekg/dns/blob/b3dfea07155dbe4baafd90792c67b85a3bf5be23/msg.go#L430-L435)
...
[dig.rb](https://gist.github.com/jvns/1e5838a53520e45969687e2f90199770). You could add more features to it if you want, like
...
Also [you can let me know on Twitter](https://twitter.com/b0rk) if I’ve made a mistake in this post somewhere
