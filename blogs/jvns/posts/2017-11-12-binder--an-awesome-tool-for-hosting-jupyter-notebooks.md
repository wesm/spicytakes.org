...
date: 2017-11-12
url: https://jvns.ca/blog/2017/11/12/binder--an-awesome-tool-for-hosting-jupyter-notebooks/
slug: binder--an-awesome-tool-for-hosting-jupyter-notebooks
word_count: 586
---


Thanks to a [pull request](https://github.com/jvns/pandas-cookbook/pull/62) today, I learned about
a thing called Binder!! [https://mybinder.org/](https://mybinder.org/).
...
- post a link to it on GitHub [https://github.com/jvns/talks/blob/master/2013-04-mtlpy/pistes-cyclables.ipynb](https://github.com/jvns/talks/blob/master/2013-04-mtlpy/pistes-cyclables.ipynb). Github has a built-in renderer for jupyter notebooks which is GREAT.
- Put it on GitHub and use [https://nbviewer.jupyter.org](https://nbviewer.jupyter.org) to share it [https://nbviewer.jupyter.org/github/jvns/talks/blob/master/2013-04-mtlpy/pistes-cyclables.ipynb](https://nbviewer.jupyter.org/github/jvns/talks/blob/master/2013-04-mtlpy/pistes-cyclables.ipynb)
...
1. Go to [https://mybinder.org/v2/gh/jvns/pandas-cookbook/master](https://mybinder.org/v2/gh/jvns/pandas-cookbook/master) (which will launch the
