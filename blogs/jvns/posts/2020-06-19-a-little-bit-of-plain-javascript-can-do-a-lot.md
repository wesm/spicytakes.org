...
slug: a-little-bit-of-plain-javascript-can-do-a-lot
word_count: 847
---
...
intro to Vue](https://jvns.ca/blog/2017/06/26/vue-js-fun/)).
...
[https://questions.wizardzines.com](https://questions.wizardzines.com), I had slightly different constraints than
usual – I wanted to use the same HTML to generate both a PDF (with
[Prince](https://www.princexml.com/)) and to make an interactive version of the questions.
...
classes, and using [CSS transitions](https://3dtransforms.desandro.com/card-flip) if I want to animate a transition.
...
I started out by editing the classes like this: `x.className = 'new list of classes'`. That felt a bit messy though and I wondered if there was a better
way. And there was!
...
implementation in
2008](https://johnresig.com/blog/thoughts-on-queryselectorall/), and [a blog
post from 2011](https://tiffanybbrown.com/2011/08/12/meet-the-selectors-api/)
...
[peekobot](https://peekobot.github.io/peekobot/), which is a little chatbot
interface that’s 100 lines of JS/CSS.


Looking at [its Javascript](https://github.com/Peekobot/peekobot/blob/master/peekobot.js),
