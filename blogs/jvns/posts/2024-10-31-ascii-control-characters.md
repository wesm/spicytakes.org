...
You can also view it [as an HTML page](https://jvns.ca/ascii) (I just made it an image so
...
(If you’re curious about readline, I wrote more about readline in [entering text in the terminal is complicated](https://jvns.ca/blog/2024/07/08/readline/), and there are a lot of
[cheat sheets out there](https://github.com/chzyer/readline/blob/master/doc/shortcut.md))
...
used for computers or terminals at all, they were used for [the telegraph machine](https://falsedoor.com/doc/ascii_evolution-of-character-codes.pdf).
...
`Ctrl-M` as keyboard shortcuts ([here’s an example](https://github.com/tmux/tmux/issues/2705)), but to do that
...
[echo-key.py](https://gist.github.com/jvns/a2ea09dbfbe03cc75b7bfb381941c742)
...
In [canonical mode](https://www.man7.org/linux/man-pages/man3/termios.3.html),
...
[asked on Mastodon](TODO) and people said the most common reasons they used
`stty` were:
...
“raw mode”, [man cfmakeraw](https://linux.die.net/man/3/cfmakeraw) talks about
that.
...
There’s an incredible [section of the Debian Policy Manual on keyboard configuration](https://www.debian.org/doc/debian-policy/ch-opersys.html#keyboard-configuration)
...
understanding (via [this mastodon post](https://tech.lgbt/@Diziet/113396035847619715))
...
almost always totally fine except when I was [trying to use xterm.js](https://jvns.ca/blog/2022/07/20/pseudoterminals/).
