...
date: 2022-06-28
url: https://jvns.ca/blog/2022/06/28/some-notes-on-bubblewrap/
slug: some-notes-on-bubblewrap
word_count: 3059
---


Hello! About a year ago I got mad about Docker container startup time. This was
because I was building an [nginx playground](https://jvns.ca/blog/2021/09/24/new-tool--an-nginx-playground/)
...
[bubblewrap](https://github.com/containers/bubblewrap)!! It’s very fast and I
...
- [containers are basically just a bunch of namespaces](https://jvns.ca/blog/2016/10/10/what-even-is-a-container/)
- what’s the problem?
...
[runc](https://github.com/opencontainers/runc) (or maybe `crun`? I can’t keep track honestly) under the hood, so I thought –
...
think it comes from [flatpak](https://flatpak.org/)).
...
There’s also a tool called [bwrap-oci](https://github.com/projectatomic/bwrap-oci) which looks cool but I
...
I wrote a post about [overlay filesystems](https://jvns.ca/blog/2019/11/18/how-containers-work--overlayfs/) if
...
- something that implements [OCI runtime specification](https://opencontainers.org/about/overview/)
...
[issue about it here that links to a workaround](https://github.com/containers/bubblewrap/issues/468).
...
Someone asked “would Firecracker work here?” (I [wrote about Firecracker](https://jvns.ca/blog/2021/01/23/firecracker--start-a-vm-in-less-than-a-second/) last year).
