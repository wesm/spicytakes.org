...
date: 2019-11-25
url: https://jvns.ca/blog/2019/11/25/challenge--make-a-bouncy-window-manager/
slug: challenge--make-a-bouncy-window-manager
word_count: 606
---


Hello! I’m writing a short series of programming challenges with
[Julian](http://www.cipht.net/2017/10/03/are-jump-tables-always-fastest.html),
...
**[tinywm](http://incise.org/tinywm.html)**, which is a tiny window manager
...
I did this challenge by modifying [tinywm](http://incise.org/tinywm.html) and it worked really well.
...
- the [dwm source code](https://git.suckless.org/dwm/file/dwm.c.html) (dwm is a 2000-line-of-C window manager)
- the [Xlib programming manual](https://tronche.com/gui/x/xlib/)
...
solution (to [julia@jvns.ca](mailto:julia@jvns.ca))!
