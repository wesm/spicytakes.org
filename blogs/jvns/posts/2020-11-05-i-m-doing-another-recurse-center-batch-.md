---
title: "I'm doing another Recurse Center batch!"
date: 2020-11-05
url: https://jvns.ca/blog/2020/11/05/i-m-doing-another-recurse-center-batch-/
slug: i-m-doing-another-recurse-center-batch-
word_count: 678
---


Hello! I’m going to do a batch (virtually) at the [Recurse Center](https://www.recurse.com/), starting on Monday. I’ll probably be
...
building some very fun [custom software](https://www.recurse.com/virtual-rc))
...
2. come up with a plan to learn the things (often the plan is “do some kind of fun project”, like [“write a TCP stack”](https://jvns.ca/blog/2014/08/12/what-happens-if-you-write-a-tcp-stack-in-python/))
3. learn the things
...
Their business model is recruiting – they [partner with](https://www.recurse.com/hire) a bunch of companies,
...
computer situations
- deal with some of the [rbspy](https://github.com/rbspy/rbspy) issues that I’ve been ignoring for months/years
