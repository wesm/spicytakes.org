---
title: "Implementing 'focus and reply' for Fastmail with JMAP"
date: 2020-08-18
url: https://jvns.ca/blog/2020/08/18/implementing--focus-and-reply--for-fastmail/
slug: implementing--focus-and-reply--for-fastmail
word_count: 1179
---


Last month I switched my email to Fastmail. One fun thing about Fastmail is
that they built a new protocol called [JMAP](https://jmap.io/) which is much
...
it out. [Here’s the github repo](https://github.com/jvns/focus-reply-fastmail) and a [gist which shows how to authenticate & make your first request](https://gist.github.com/jvns/738eda48bff8c4dd2a5e349b8df7c7a8).


### cool feature from Hey: focus & reply


I tried the [https://hey.com](https://hey.com) email service for a little bit when it came out. It wasn’t for me, but I
liked their “focus and reply” feature. Here’s a screenshot of what it looks like (from a video on their [marketing site page for the feature](https://hey.com/features/reply-mode/))


![](https://jvns.ca/images/original-feature-screenshot.png)
...
![](https://jvns.ca/images/focus-reply.png)
...
in a gist:
[fastmail-jmap-quickstart.js](https://gist.github.com/jvns/738eda48bff8c4dd2a5e349b8df7c7a8)
...
1. Make a GET request to [https://jmap.fastmail.com/.well-known/jmap](https://jmap.fastmail.com/.well-known/jmap). This gives
...
2. Use that account ID to make requests to the JMAP API at [https://jmap.fastmail.com/api/](https://jmap.fastmail.com/api/)
...
I wanted to by reading the spec at [https://jmap.io](https://jmap.io).


### step 2: get all my emails


Here’s [the query I used to get my emails from JMAP](https://github.com/jvns/focus-reply-fastmail/blob/726f9ae90a0cab746115a1f645596cd26e7dcafc/focus-and-reply.js#L38-L74).
...
Once I had all the emails, rendering them was pretty easy – I just used vue.js + Tailwind.
The whole thing came out to [170 lines of not-particularly-well-organized Javascript](https://github.com/jvns/focus-reply-fastmail/blob/726f9ae90a0cab746115a1f645596cd26e7dcafc/focus-and-reply.js).


### the results


It works! It’s already helped me reply to some emails.  The github repo is [https://github.com/jvns/focus-reply-fastmail](https://github.com/jvns/focus-reply-fastmail).


there are at least 2 problems with this code (and probably more):

1. it’s storing passwords in local storage, which I think is not a good
security practice.
2. it had some XSS vulnerabilities, which I think I’ve finally fixed by putting
...
1. Fastmail’s webmail interface doesn’t seem to use [https://jmap.fastmail.com/](https://jmap.fastmail.com/) – instead it uses [https://www.fastmail.com/jmap/api](https://www.fastmail.com/jmap/api). Maybe it’s just a proxy they use so that the requests are being made to the same origin? Unclear.
2. It also authenticates in a different way, using `Authorization: Bearer`. It
...
3. The requests it sends are sometimes compressed with deflate for some reason
...
- [JMAP crash course](https://jmap.topicbox.com/groups/fastmail-dev-beta/T83594f41ca76f56c/jmap-crash-course) (which I only found after I’d already finished doing this but looks very useful!)
- Fastmail has [some JMAP sample code on github](https://github.com/fastmail/JMAP-Samples)
- [https://jmap.io/](https://jmap.io/) for the specs
- [https://github.com/cure53/DOMPurify](https://github.com/cure53/DOMPurify) is an HTML sanitizer which looks useful for preventing XSS
