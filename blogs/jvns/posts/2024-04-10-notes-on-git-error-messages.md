...
slug: notes-on-git-error-messages
word_count: 2075
---
...
“`asdf` isn’t a branch, but it’s not a tag either, or any other reference”. From my various [git polls](https://jvns.ca/blog/2024/03/28/git-poll-results/) my impression is that
