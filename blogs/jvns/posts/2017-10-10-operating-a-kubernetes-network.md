...
date: 2017-10-10
url: https://jvns.ca/blog/2017/10/10/operating-a-kubernetes-network/
slug: operating-a-kubernetes-network
word_count: 2415
---
...
- Your overlay network is probably dependent on a distributed database (etcd). If that database has an incident, this can cause issues. For example [https://github.com/coreos/flannel/issues/610](https://github.com/coreos/flannel/issues/610) says that if you have data loss in your flannel etcd cluster it can result in containers losing network connectivity. (this has now been fixed)
...
- How GKE networking works:  [https://www.youtube.com/watch?v=y2bhV81MfKQ](https://www.youtube.com/watch?v=y2bhV81MfKQ)
- The aforementioned talk on `kube-proxy` performance: [https://www.youtube.com/watch?v=4-pawkiazEg](https://www.youtube.com/watch?v=4-pawkiazEg)
