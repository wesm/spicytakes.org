...
date: 2019-10-28
url: https://jvns.ca/blog/2019/10/28/sqlite-is-really-easy-to-compile/
slug: sqlite-is-really-easy-to-compile
word_count: 822
---


In the last week I’ve been working on another SQL website
([https://sql-steps.wizardzines.com/](https://sql-steps.wizardzines.com/), a list of SQL examples). I’m running all
the queries on that site with sqlite, and I wanted to use window functions in
one of the examples ([this one](https://sql-steps.wizardzines.com/lag.html)).
...
(spoiler: the summary is that [https://www.sqlite.org/howtocompile.html](https://www.sqlite.org/howtocompile.html) explains
...
The [SQLite download page](https://www.sqlite.org/download.html) has a link to
...
I googled this problem (by searching “execve enoent”), found [this stack overflow answer](https://stackoverflow.com/questions/5234088/execve-file-not-found-when-stracing-the-very-same-file),
...
testing](https://packages.debian.org/bullseye/amd64/sqlite3/download). Trying
...
SQLite](https://www.sqlite.org/howtocompile.html). And they’re the EASIEST
...
- download an [amalgamation tarball from the download page](https://www.sqlite.org/download.html)
...
I’ve had fun [editing sqlite’s source code](https://jvns.ca/blog/2014/10/02/how-does-sqlite-work-part-2-btrees/) to
