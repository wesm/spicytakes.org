...
slug: examples-of-floating-point-problems
word_count: 2563
---
...
So I [asked on Mastodon](https://mastodon.social/@b0rk/109670855322107281) for
...
![](https://wizardzines.com/comics/floating-point/floating-point.png)
...
I got those numbers by going to [https://float.exposed/0x48800000](https://float.exposed/0x48800000) and incrementing the ‘significand’ number a couple of times.
...
from [this blog post](https://jonisalonen.com/2013/deriving-welfords-method-for-computing-variance/). Here’s some Python code:
...
[The blog post I mentioned before](https://jonisalonen.com/2013/deriving-welfords-method-for-computing-variance/)
...
that](https://github.com/microsoft/WSL/issues/830)
...
called the [Deep Space Kraken](https://wiki.kerbalspaceprogram.com/wiki/Deep_Space_Kraken) where when
...
Another example of this is the [Far Lands](https://minecraftbedrock-archive.fandom.com/wiki/Far_Lands) in Minecraft.
...
usually a problem. (there’s always still the [year 2038 problem](https://en.wikipedia.org/wiki/Year_2038_problem), but that’s not
related to floats)
