---
title: "New zine: Hell Yes! CSS!"
date: 2020-11-22
url: https://jvns.ca/blog/2020/11/22/new-zine--hell-yes--css-/
slug: new-zine--hell-yes--css-
word_count: 935
---
...
[https://wizardzines.com/zines/css](https://wizardzines.com/zines/css), or get
a [9-pack of all my zines here](https://wizardzines.com/zines/all-the-zines/)
for $88.
...
[Melody Starling](https://melody.dev) to design & implement [https://wizardzines.com](https://wizardzines.com) for me.
...
[https://codepen.io/wizardzines/pen/ZEOzqaN](https://codepen.io/wizardzines/pen/ZEOzqaN)
...
So I built [CSS examples](https://css-examples.wizardzines.com/) ([https://css-examples.wizardzines.com/](https://css-examples.wizardzines.com/)) to help with
this a little bit. It has about 20 examples illustrating various CSS facts.
Some of them are relatively straightforward (like the one on [border-radius](https://css-examples.wizardzines.com/#different-border-radius)),
and some of them are pretty surprising and confusing at first, like this one on
how [left: 0; right: 0 is different from width: 100%;](https://css-examples.wizardzines.com/#left-right-vs-width) and this super weird thing
about how [inline-block elements are aligned differently depending on whether
they have text in them](https://css-examples.wizardzines.com/#inline-block-text).


You can edit them all using the amazing [https://codepen.io/](https://codepen.io/) (click “Edit on
...
[études](https://en.wikipedia.org/wiki/%C3%89tude)” – basically “here’s a
design, implement this in CSS”. If this already exists, I’d love to know about it!


Here’s a link to where to [get Hell Yes!
CSS!](https://wizardzines.com/zines/css) again :). As usual if you’re in a
