---
title: "Why might you run your own DNS server?"
date: 2022-01-05
url: https://jvns.ca/blog/2022/01/05/why-might-you-run-your-own-dns-server-/
slug: why-might-you-run-your-own-dns-server-
word_count: 1790
---
...
[this tweet phrased it well](https://twitter.com/thatcks/status/1478503078680838153):
...
- Replit has a blog post about [why they wrote their own authoritative DNS server to handle routing](https://blog.replit.com/dns)
- [nip.io](https://nip.io) maps 10.0.0.1.nip.io to 10.0.0.1
- I wrote a custom DNS server for [mess with dns](https://jvns.ca/blog/2021/12/15/mess-with-dns/)
...
- [Pi-Hole](https://pi-hole.net/) blocks advertisers
- [Quad9](https://www.quad9.net/) blocks domains that do malware/phishing/spyware. Cloudflare seems to have a [similar service](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families)
