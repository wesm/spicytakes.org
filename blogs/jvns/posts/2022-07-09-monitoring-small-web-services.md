...
slug: monitoring-small-web-services
word_count: 991
---
...
[dns lookup](https://dns-lookup.jvns.ca)), so I’ve been
...
there, the ones I’m using right now are [updown.io](https://updown.io/) and
[uptime robot](https://uptimerobot.com/). I like updown’s user interface and
[pricing](https://updown.io/#pricing) structure more (it’s per request instead of a monthly fee), but uptime
