...
slug: getting-a-modern-terminal-setup
word_count: 2178
---
...
- text editor: this is a tough one, maybe [micro](https://micro-editor.github.io/) or [helix](https://helix-editor.com/)? I haven’t used
...
And even though [I love fish](https://jvns.ca/blog/2024/09/12/reasons-i--still--love-fish/), the fact
...
probably start with something like `export PS1='[\u@\h \W$(__git_ps1 " (%s)")]\$ '`, or maybe use [starship](https://starship.rs/)).
...
[oh-my-zsh](https://ohmyz.sh/). It seems like a great project and I know a lot
...
I made [a list here](https://jvns.ca/blog/2022/04/12/a-list-of-new-ish--command-line-tools/)),
...
SSH, I’d need to make sure that my terminal emulator has [OSC 52 support](https://old.reddit.com/r/vim/comments/k1ydpn/a_guide_on_how_to_copy_text_from_anywhere/)
...
with a [shell script](https://github.com/chriskempson/base16-shell/blob/588691ba71b47e75793ed9edfcfaa058326a6f41/scripts/base16-solarized-light.sh) that I run when my shell starts, but that means the
...
using `ls` to [eza](https://github.com/eza-community/eza) a year or two ago and
