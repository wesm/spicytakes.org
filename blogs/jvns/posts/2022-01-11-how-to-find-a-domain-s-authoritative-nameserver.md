---
title: "How to find a domain's authoritative nameservers"
date: 2022-01-11
url: https://jvns.ca/blog/2022/01/11/how-to-find-a-domain-s-authoritative-nameserver/
slug: how-to-find-a-domain-s-authoritative-nameserver
word_count: 1246
---
...
nameservers. `h.root-servers.net` is one of the [13 DNS root nameservers](https://www.iana.org/domains/root/servers), and `dig @h.root-servers.net` means “send the query to `h.root-servers.net`”.
...
2. The NS record you get doesn’t come from the same place as it does when we do
...
1. This response comes from your authoritative nameserver. So if you’re in the
...
2. Your authoritative nameserver could be returning a SOA record which doesn’t
