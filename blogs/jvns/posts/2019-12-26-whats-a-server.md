---
title: "'server' is hard to define"
date: 2019-12-26
url: https://jvns.ca/blog/2019/12/26/whats-a-server/
slug: whats-a-server
word_count: 1528
---
...
of servers. For example if you search Newegg for [1U server](https://www.newegg.com/p/pl?d=1u+server) you’ll find servers that are 1
“[rack unit](https://en.wikipedia.org/wiki/Rack_unit)” high, and a rack unit is 1.75 inches. There are also 2U servers which are twice as high.


Here’s a picture of a 1U server I found on Newegg:


![](https://c1.neweggimages.com/NeweggImage/ProductImage/11-152-136-02.jpg)


I’ve only seen a server rack once at the [Internet
Archive](https://archive.org/) which is in what used to be a church in San
