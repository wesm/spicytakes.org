...
date: 2021-12-04
url: https://jvns.ca/blog/2021/12/04/how-to-use-dig/
slug: how-to-use-dig
word_count: 1457
---
...
I also drew a [zine page about dig](https://wizardzines.com/comics/dig/) a few years ago, but I wanted to write this post to include a bit more information.
...
Anyway, I think that these simpler DNS tools are great (I even made my own [simple web DNS tool](https://dns-lookup.jvns.ca/)) and you should
