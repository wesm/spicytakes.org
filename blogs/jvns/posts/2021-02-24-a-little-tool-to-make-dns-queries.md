---
title: "A little tool to make DNS queries"
date: 2021-02-24
url: https://jvns.ca/blog/2021/02/24/a-little-tool-to-make-dns-queries/
slug: a-little-tool-to-make-dns-queries
word_count: 984
---


Hello! I made a small tool to make DNS queries
over the last couple of days, and you can try it at [https://dns-lookup.jvns.ca/](https://dns-lookup.jvns.ca/).
...
Google has a [DNS lookup tool](https://toolbox.googleapps.com/apps/dig/#A/) with a simple web
...
![](https://jvns.ca/images/google-tool.png)
...
– Cloudflare has a good blog post explaining [why they removed support for ANY](https://blog.cloudflare.com/deprecating-dns-any-meta-query-type/).
...
query for A records on www.twitter.com](https://dns-lookup.jvns.ca/#www.twitter.com%7CA) that it replies
with a CNAME record because [www.twitter.com](https://www.twitter.com) is CNAMEd to twitter.com.


### how it works


The source is on GitHub at [https://github.com/jvns/dns-lookup](https://github.com/jvns/dns-lookup).


It’s basically just 3 files right now:

- [dns.js](https://github.com/jvns/dns-lookup/blob/4be37ca3681480ed0f15a670fbd854ca427329de/site/dns.js) (some Javascript using vue.js)
- [index.html](https://github.com/jvns/dns-lookup/blob/4be37ca3681480ed0f15a670fbd854ca427329de/site/index.html)
- [dns.go](https://github.com/jvns/dns-lookup/blob/4be37ca3681480ed0f15a670fbd854ca427329de/dns.go) is the backend, it’s a Go HTTP handler running on Netlify functions
...
library, but I ended up using [https://github.com/miekg/dns](https://github.com/miekg/dns) to make the DNS
...
- [zone.vision](https://zone.vision/#/twitter.com), which is nice because it queries the authoritative nameservers for a domain directly
- [mxtoolbox.com](https://mxtoolbox.com/SuperTool.aspx), which seems a bit more oriented towards MX/SPF queries but does lots more
- the [Google DNS lookup tool](https://toolbox.googleapps.com/apps/dig/#A/) again
...
Here’s it is! [https://dns-lookup.jvns.ca/](https://dns-lookup.jvns.ca/).
