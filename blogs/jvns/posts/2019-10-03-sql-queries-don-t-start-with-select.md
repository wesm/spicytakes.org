...
slug: sql-queries-don-t-start-with-select
word_count: 1082
---
...
functions](https://tweets.jvns.ca/b0rk/status/1179419244808851462?s=20), and I
...
I looked up the order, and here it is! (SELECT isn’t the first thing, it’s like the 5th thing!) ([here it is in a tweet](https://tweets.jvns.ca/b0rk/status/1179449535938076673)).
...
tool](https://github.com/jvns/pandas-cookbook)) also basically works like this,
