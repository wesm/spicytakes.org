...
date: 2023-03-03
url: https://jvns.ca/blog/2023/03/03/how-do-nix-builds-work-/
slug: how-do-nix-builds-work-
word_count: 2571
---


Hello! For some reason after the last [nix post](https://jvns.ca/blog/2023/02/28/some-notes-on-using-nix/) I got nerdsniped by trying to understand how Nix builds
...
> starting with [this bash script](https://github.com/NixOS/nixpkgs/blob/master/pkgs/stdenv/generic/setup.sh)
...
compile it in [this post](https://jvns.ca/blog/2023/02/28/some-notes-on-using-nix/) by copying and pasting a bunch of stuff I didn’t understand, but this time I wanted to do
...
[documentation](https://nixos.org/manual/nix/stable/language/derivations.html)), but “it builds all of its inputs” is all we really need to know
for now.
...
Those bash script environment variables are `eval`ed in the main bash script (you can [see that happening in setup.sh here](https://github.com/NixOS/nixpkgs/blob/fc2bfe1cdc910104e6df52c5dc449e8f855c66b7/pkgs/stdenv/generic/setup.sh#L61-L74))
