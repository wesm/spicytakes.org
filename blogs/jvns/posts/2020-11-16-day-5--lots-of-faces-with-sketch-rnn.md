---
title: "Day 5: drawing lots of faces with sketch-rnn"
date: 2020-11-16
url: https://jvns.ca/blog/2020/11/16/day-5--lots-of-faces-with-sketch-rnn/
slug: day-5--lots-of-faces-with-sketch-rnn
word_count: 598
---
...
Someone suggested the [Google Quickdraw](https://quickdraw.withgoogle.com/data/face) dataset, which has a lot
...
![](https://jvns.ca/images/face1.jpg)


![](https://jvns.ca/images/face2.jpg)
...
sketchpad](https://magic-sketchpad.glitch.me/) demo here – you start making a
drawing, and it’ll complete you drawing as a cat / bridge / whatever you want.


I figured that would be a fun place to start, and [ml5js](https://learn.ml5js.org) has a [tutorial showing how to write Javascript code to draw things with sketch-rnn](https://github.com/ml5js/ml5-library/tree/main/examples/javascript/SketchRNN/SketchRNN_interactive), which I followed.
...
[lots of sketch-rnn faces](https://lots-of-sketchrnn-faces.netlify.app/). You can see it “live” drawing the faces which is fun.


The set of images that comes out looks something like this:


![](https://jvns.ca/images/faces.png)
...
![](https://jvns.ca/images/boring-face.png)
...
I did find someone who’d done something kind of similar, on [bad flamingos vs good flamingos](https://colinmorris.github.io/blog/bad_flamingos) in the quickdraw dataset.
...
[https://refrigerator-poetry-forum.herokuapp.com/](https://refrigerator-poetry-forum.herokuapp.com/). You can write magnet
