...
slug: debug-your-programs-like-theyre-closed-source
word_count: 1460
---
...
calls. To spy on our backup program, we would run `strace -e trace=open -p 60`, to tell it to print all the `open` system calls from PID 60.
...
`-f`.
([[longer blog post about using strace + execve to poke at Ruby programs]](https://jvns.ca/blog/2014/02/26/using-strace-to-avoid-reading-ruby-code/)).
...
example, one of my Chrome processes has PID 3823. If I run `ls -l /proc/3823/fd/*`, it shows me all the files Chrome has open!
...
I have an
[ever-growing collection of blog posts about strace](https://jvns.ca/categories/strace),
too!
...
Thanks to [Lindsey Kuper](http://decomposition.al/) and
