...
date: 2019-09-30
url: https://jvns.ca/blog/2019/09/30/notes-on-building-sql-exercises/
slug: notes-on-building-sql-exercises
word_count: 1030
---
...
is that I read [Design for how people learn](https://www.amazon.com/Design-People-Learn-Voices-Matter/dp/0321768434)
...
GROUP BY](https://joins-238123.netlify.com/aggregations/). Here’s a screenshot of what the initial “challenge” for basic group by looks like:
...
- [sql.js](https://github.com/kripken/sql.js) to run the SQL queries in the browser with SQLite (there’s no server, it’s all done in the browser, so nobody can take down the server by running really expensive queries :) )
- [firestore](https://firebase.google.com/docs/firestore) to store the queries people are trying out
- [vue.js](https://vuejs.org) to manage Javascript components
- [typescript](https://www.typescriptlang.org/) to compensate a bit for my lack of Javascript experience and help me refactor my code more easily
- [tailwind css](https://tailwindcss.com/) for CSS


I also bought the [Refactoring UI](https://refactoringui.com/) book to try to improve my web design skills a tiny bit. I think it’s helped a little so far.
