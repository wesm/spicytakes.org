...
slug: asn-ip-address-memory
word_count: 2613
---


I’ve been having problems for the last 3 years or so where [Mess With DNS](https://messwithdns.net/)
...
A while back I set [GOMEMLIMIT](https://tip.golang.org/doc/gc-guide) to 250MB
...
ASN of every IP address](https://iptoasn.com/) into memory, so that when it
...
originally thought `BLOB`s couldn’t be compared but the [sqlite docs](https://www.sqlite.org/datatype3.html#sort_order) say they can.
...
[ipaddress-go](https://github.com/seancfoley/ipaddress-go) that lets you look up IP addresses using a trie.


I tried using it [here’s the code](https://gist.github.com/jvns/3ce617796b22127017590ac62c57fddd), but I
...
every time I use pprof I find myself referring to [my own intro to pprof](https://jvns.ca/blog/2017/09/24/profiling-go-with-pprof/), it’s probably
...
IP address library for Go which solves this and many other issues. [They wrote a great blog post about it](https://tailscale.com/blog/netaddr-new-ip-type-for-go).
...
standard library as [netip.Addr](https://pkg.go.dev/net/netip#Addr). Switching to `netip.Addr` was
