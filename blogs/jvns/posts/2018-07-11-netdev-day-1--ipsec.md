...
date: 2018-07-11
url: https://jvns.ca/blog/2018/07/11/netdev-day-1--ipsec/
slug: netdev-day-1--ipsec
word_count: 1372
---
...
used to rules about what to do to packets in various IP ranges being in the route table (`sudo ip route list`), but apparently you can have IPsec rules too and they’re in a different place!
...
1. `unbound` makes a DNS query for the IPSECKEY record of oe.libreswan.org (`dig ipseckey oe.libreswan.org`) to get a public key to use for that domain. (this requires DNSSEC to be secure
