...
slug: branches-intuition-reality
word_count: 1948
---
...
![](https://jvns.ca/images/git-branch.png)
...
![](https://jvns.ca/images/gh-pr.png)
...
![](https://jvns.ca/images/backwards-rebase.png)
...
![](https://jvns.ca/images/merge-two-ways.png)
...
hierarchy between your branches every time you run a `git rebase` or `git merge` command – for me it’s second nature to do that and it’s not a big deal,
