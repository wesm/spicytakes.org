---
title: "How I write useful programming comics"
date: 2020-12-05
url: https://jvns.ca/blog/2020/12/05/how-i-write-useful-programming-comics/
slug: how-i-write-useful-programming-comics
word_count: 1396
---
...
The other day a friend was asking me how I write [programming comics](https://wizardzines.com). I’ve tried
to write about this at least 6 times
([1](https://jvns.ca/blog/2019/09/01/ways-to-write-zines-without-fancy-tools/),
[2](https://jvns.ca/blog/2018/12/09/how-do-you-document-a-tech-project-with-comics/),
[3](https://jvns.ca/blog/2018/10/28/when-does-teaching-with-comics-work-well/),
[4](https://jvns.ca/teach-tech-with-cartoons/),
[5](https://jvns.ca/blog/2016/11/14/why-cute-drawings/),
[6](https://jvns.ca/blog/2016/08/29/how-i-made-a-zine/)), but I felt like
...
But neither of these is what I actually find hard about comics: I’m actually [very bad at drawing](https://jvns.ca/teach-tech-with-cartoons/), and I’ve made comics that people love with very simple tools, like taking a [low-quality picture of a notebook with my phone](https://tweets.jvns.ca/b0rk/status/638365065926811648).
...
- [SELECT queries aren’t executed in the order they’re written in](https://wizardzines.com/comics/sql-query-order/)
- [position: absolute isn’t absolute](https://wizardzines.com/comics/position-absolute/)
- [cookies let a server store information in your browser](https://tweets.jvns.ca/b0rk/status/1158848054142873603)
- [the /proc directory on linux lets you access information about processes](https://tweets.jvns.ca/b0rk/status/981159808832286720)
- [linux uses copy on write for a new process’s memory](https://tweets.jvns.ca/b0rk/status/987727508241092608)
- [ngrep is like ‘grep’ for network packets](https://tweets.jvns.ca/b0rk/status/1102027359874703360)
- [a git branch is a pointer to a commit](https://tweets.jvns.ca/b0rk/status/1044403728336310273)
- [if you ask about specific things you want feedback on, you’re more likely to get the feedback you need](https://wizardzines.com/comics/ask-for-specific-feedback/)
- [container layers are implemented using overlay filesystems](https://wizardzines.com/comics/overlay-filesystems/)
...
- [what to talk about in 1:1s with your manager](https://wizardzines.com/comics/1-1s/)
...
- [ways I want my team to be](https://drawings.jvns.ca/team/)
- [grep’s command line arguments](https://wizardzines.com/comics/grep/)
- [find’s command line arguments](https://wizardzines.com/comics/find/)
- [dig’s command line arguments](https://wizardzines.com/comics/dig/)
- about 30 other “X’s most important command line arguments and what they do”
(basically all of [bite size command
line](https://wizardzines.com/zines/bite-size-command-line) and [bite size
networking](https://wizardzines.com/zines/bite-size-command-line))
...
- [take on hard projects](https://wizardzines.com/comics/take-on-hard-projects/)
- [how I got better at debugging](https://wizardzines.com/comics/better-at-debugging/)
- [how to be a wizard programmer](https://wizardzines.com/comics/wizard-programmer/)
- [data analysis is always more work than I think](https://tweets.jvns.ca/b0rk/status/617003669561679872)
...
Another example of this is [SELECT queries start with FROM](https://wizardzines.com/comics/sql-query-order/) – this was something
