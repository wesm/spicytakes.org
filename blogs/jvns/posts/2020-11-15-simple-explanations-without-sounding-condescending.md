...
slug: simple-explanations-without-sounding-condescending
word_count: 1074
---


Sumana Harihareswara wrote an interesting blog post [Plain Language
Choices](https://www.harihareswara.net/sumana/2020/11/12/0) recently, about
...
I think [why’s poignant guide to ruby](https://poignant.guide/) is a nice
...
It’s called “I’m supposed to relate to this?”, here’s the [paperback](https://untrans.bigcartel.com/).
...
example [https://howdns.works/](https://howdns.works/) tells a story about how DNS works. Everything
...
[Gödel’s Second Incompleteness Theorem Explained in Words of One Syllable](https://www2.kenyon.edu/Depts/Math/Milnikel/boolos-godel.pdf).
...
things, like [a blog post by John Baez from 2011 discussing an attempted proof that Peano arithmetic was inconsistent](https://golem.ph.utexas.edu/category/2011/09/the_inconsistency_of_arithmeti.html))


(I’m also reminded here of the XKCD [up goer five](https://xkcd.com/1133/),
