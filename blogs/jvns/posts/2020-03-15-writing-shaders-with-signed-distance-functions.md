---
title: "Getting started with shaders: signed distance functions!"
date: 2020-03-15
url: https://jvns.ca/blog/2020/03/15/writing-shaders-with-signed-distance-functions/
slug: writing-shaders-with-signed-distance-functions
word_count: 1656
---
...
![](https://jvns.ca/images/spinny.gif)
...
tutorial: box & balloon](https://www.shadertoy.com/view/Xl2XWt).
...
1. this very complicated shader that is like a realistic video of a river: [https://www.shadertoy.com/view/Xl2XRW](https://www.shadertoy.com/view/Xl2XRW)
2. a more abstract (and shorter!) fun shader with a lot of glowing circles: [https://www.shadertoy.com/view/lstSzj](https://www.shadertoy.com/view/lstSzj)
...
[https://www.shadertoy.com/new](https://www.shadertoy.com/new). They give you a default shader to start with
that looks like this:


![](https://jvns.ca/images/colour.gif)
...
I found a command line tool that will watch a file and update the animation in real time every time I save called [shadertoy-render](https://github.com/alexjc/shadertoy-render). So now I can just run:
...
![](https://jvns.ca/images/circle.gif)


Here’s the code:  (which you can also [see on shadertoy](https://www.shadertoy.com/view/tsscR4))
...
2. Raytrace the signed distance function so you can display it in a 2D picture
...
because I found this [AMAZING tutorial on signed distance functions](https://www.shadertoy.com/view/Xl2XWt) that is very
...
- The tutorial is called “SDF Tutorial: box & balloon” and it’s here: [https://www.shadertoy.com/view/Xl2XWt](https://www.shadertoy.com/view/Xl2XWt)
- Here are tons of signed distance functions that you can copy and paste into your code [http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm](http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm) (and ways to compose them to make other shapes)
...
My final shader of a bunch of shiny spinny things is here: [https://www.shadertoy.com/view/wdlcR4](https://www.shadertoy.com/view/wdlcR4)


The animation comes out looking like this:


![](https://jvns.ca/images/octahedron2.gif)
...
page](http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm)
...
a noise funciton that I found in [this github gist](https://gist.github.com/patriciogonzalezvivo/670c22f3966e662d2f83) to
...
1. “SDF Tutorial: box & balloon”: [https://www.shadertoy.com/view/Xl2XWt](https://www.shadertoy.com/view/Xl2XWt) (which is really fun to modify and play around with)
2. Tons of signed distance functions that you can copy and paste into your code [http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm](http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm)
