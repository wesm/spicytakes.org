...
slug: new-talk-learning-dns-in-10-years
word_count: 4729
---


Here’s a keynote I gave at [RubyConf Mini](https://www.rubyconfmini.com/) last year: Learning DNS in 10 years.
...
You all got this zine (
[How DNS Works](https://wizardzines.com/zines/dns/)
) in your swag bags -- thanks to RubyConf for printing it!
But this talk is
...
every time you go to a website like
, your browser
...
this document ([RFC
1035](https://datatracker.ietf.org/doc/html/rfc1035)) which defines how DNS works, that was written in 1987. And if
...
browser needs to look up the IP address for
. We
can do that in dig!
When we run
...
So I'm going to make a few queries for it, with
. 
...
a DNS query in Ruby from scratch](https://jvns.ca/blog/2022/11/06/making-a-dns-query-in-ruby-from-scratch/). It talks about how to decode the
response.
...
pages. It’s here and you can get it for $12: [How DNS Works](https://wizardzines.com/zines/dns/).
