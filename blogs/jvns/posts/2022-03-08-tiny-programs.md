...
website and generate a calendar. Here’s [the code](https://gist.github.com/jvns/a552895b6f9b523276e88d7e7506ee86) and [the output](https://jvns.ca/fringe-2021).


### printing out covers for tiny books


I saw a [TikTok video](https://www.tiktok.com/@stevieandjohn/video/7063929340836334895) recently where someone made miniature physical versions of the
...
([tinybooks.html](https://gist.github.com/jvns/de0671d09f5752d36cbe6082d4fb2af2)), converted it to a PDF, and printed it out.
...
family member, and I didn’t like the available software. So I wrote a [tiny shell script wrapper for `scanimage`](https://gist.github.com/jvns/b5651fd6272eddcd935e5e30874a935f) to
...
with some of my interests. So I wrote general software to [generate crosswords from a text file](https://github.com/jvns/svg_crossworder). I’m pretty sure
...
This was so little code I’ll just inline it here. (it’s Python). Here’s [the output]([https://gist.github.com/jvns/e4a35ca2bad90c1a0fcaf578a803b456](https://gist.github.com/jvns/e4a35ca2bad90c1a0fcaf578a803b456)
...
Notability and wanted to get my old drawings into Notability. So I [reverse engineered the Notability file format](https://jvns.ca/blog/2018/03/31/reverse-engineering-notability-format/).
...
wrote a [small website](https://turn-off-retweets.glitch.me/) so I could turn off retweets.
