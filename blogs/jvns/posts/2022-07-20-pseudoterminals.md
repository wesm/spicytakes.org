...
But this past week I was using [xterm.js](https://xtermjs.org/) to display an
...
[goterm](https://github.com/freman/goterm) that runs a Go server that lets you
...
I [forked it](https://github.com/jvns/goterm) to make it work with the latest xterm.js,
...
1. Echoing: The client sends `l` and then immediately receives an `l` sent
...
3. Escape sequences: `\x1b` is the ASCII escape character, so `\x1b[?2004h` is
...
cursor’s position, make text bold or underlined, change colours, etc. [Wikipedia has some history](https://en.wikipedia.org/wiki/ANSI_escape_code) if you’re interested.
...
is in black. [This page](https://misc.flogisoft.com/bash/tip_colors_and_formatting) has some nice
...
terminal code](https://github.com/doy/vt100-rust) about this and Jesse told me
...
[goterm](https://github.com/freman/goterm/blob/a644c10e180ce8af789ea3e4e4892dcf078e97e2/main.go#L110-L115)
