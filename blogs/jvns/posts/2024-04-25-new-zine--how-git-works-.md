...
[https://wizardzines.com/zines/git](https://wizardzines.com/zines/git), or get
an [14-pack of all my zines here](https://wizardzines.com/zines/all-the-zines/).
...
on? [Oh Shit, Git!](https://wizardzines.com/zines/oh-shit-git) is a set of tricks for fixing git messes. [“How Git Works”](https://wizardzines.com/zines/git/)
explains how Git **actually** works.


Also, Oh Shit, Git! is the amazing [Katie Sylor Miller](https://sylormiller.com/)’s [concept](https://ohshitgit.com/): we made it
...
But thanks to a huge amount of help from [Marie](https://marieflanagan.com/) as
...
out there already ([1](https://maryrosecook.com/blog/post/git-from-the-inside-out), [2](https://shop.jcoglan.com/building-git/)), and partly because I think even if you *have* read one
...
for example [this page](https://git-scm.com/book/en/v2/Git-Branching-Remote-Branches) says:
...
I worked with [Marie Claire LeBlanc Flanagan](https://marieflanagan.com/) every
...
Git](https://shop.jcoglan.com/building-git/)) did technical review, our
...
- get a [14-pack of all my zines here](https://wizardzines.com/zines/all-the-zines/).
