...
date: 2021-06-08
url: https://jvns.ca/blog/2021/06/08/reasons-why-bugs-might-feel-impossible/
slug: reasons-why-bugs-might-feel-impossible
word_count: 2423
---


Hello! I’m [very slowly](https://jvns.ca/blog/2019/06/23/a-few-debugging-resources/)
working on writing a zine about debugging, so I [asked on Twitter the other day](https://twitter.com/b0rk/status/1400169409277218821):
...
I thought [this description](https://twitter.com/BFormations/status/1400180379051597824) was really great:
...
existed. For example, when I was debugging [this TCP issue](https://jvns.ca/blog/2015/11/21/why-you-should-understand-a-little-about-tcp/),
...
Another example of “the bug is in a surprising place” is [this case of a bug in a scanner](http://www.dkriesel.com/en/blog/2013/0802_xerox-workcentres_are_switching_written_numbers_when_scanning).
...
2. it’s not always easy to modify the library and get your program to use your
...
- “values of β may give rise to dom!”, from [this talk by Mark Allen on that error message](https://www.youtube.com/watch?v=FyLnF9U18rY) or
- “Size must be between and 16793600(16MB) First element: oints” from the talk [The tales of the cursed operating systems textbook](https://youtu.be/QxtwVsHxvC4?t=471) by Kiran Bhattaram
...
experienced](https://gcc.gnu.org/bugzilla/show_bug.cgi?id=38644))
...
1. one input causes your code to break, but it succeeds on a bunch of other
...
3. a very small code change has caused a bug and you really think it shouldn’t
have made any difference
4. the exact same code is running on the same inputs, but there’s some external
...
One [example from twitter](https://twitter.com/EllieOnSoftware/status/1400494936877846530):
