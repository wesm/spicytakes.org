...
slug: docker-compose-is-nice
word_count: 1804
---


Hello! Here is another post about [computer tools that I’ve appreciated](https://jvns.ca/#cool-computer-tools---features---ideas). This one is about Docker Compose!
...
- a nginx proxy
- a Rails server
- a Go server (which proxies some SSH connections with [gotty](https://github.com/yudai/gotty/))
- a Postgres database
...
- there’s a small bash script [wait-for-it](https://github.com/vishnubob/wait-for-it) that you can use to make a container wait for another service to be available
...
Docker also seems to have a feature to [automatically deploy your docker-compose setup to ECS](https://docs.docker.com/cloud/ecs-integration/),
