...
slug: firecracker--start-a-vm-in-less-than-a-second
word_count: 2722
---


Hello! I spent this whole past week figuring out how to use [Firecracker](https://github.com/firecracker-microvm/firecracker/) and
I really like it so far.


Initially when I read about Firecracker being released, I thought it was just a
tool for cloud providers to use – I knew that AWS Fargate and [https://fly.io](https://fly.io)
...
Firecracker’s [getting started](https://github.com/firecracker-microvm/firecracker/blob/fea3897ccfab0387ce5cd4fa2dd49d869729d612/docs/getting-started.md#getting-the-firecracker-binary) instructions
...
I also put this script in a gist: [firecracker-hello-world.sh](https://gist.github.com/jvns/c8470e75af67deec2e91ff1bd9883e53).
...
[firecracker-demo](https://github.com/firecracker-microvm/firecracker-demo/) repository which I found really helpful.
...
[firecracker-hello-world-docker-bridge.sh ](https://gist.github.com/jvns/e13e6f498d26b584d8ab66651cdb04e0)
...
1. Make a Linux kernel. I wanted a 5.8 kernel so I used the instructions in the
[firecracker docs on creating your own image](https://github.com/firecracker-microvm/firecracker/blob/fea3897ccfab0387ce5cd4fa2dd49d869729d612/docs/rootfs-and-kernel-setup.md)
...
discovered that there’s a [Go SDK](https://github.com/firecracker-microvm/firecracker-go-sdk)! This made it
...
I basically wrote all of my code so far by copying and modifying code from [firectl](https://github.com/firecracker-microvm/firectl/), a Go command line
...
If you’re interested you can see [a gist with my current HTTP service for managing Firecracker VMs](https://gist.github.com/jvns/9b274f24cfa1db7abecd0d32483666a3) which is a
...
article](https://lwn.net/Articles/775736/) says that it’s because Firecracker
...
- Shuveb Hussain’s great post [How AWS Firecracker works: a deep dive](https://unixism.net/2019/10/how-aws-firecracker-works-a-deep-dive/)
explains how Firecracker works and demonstrates some of the concepts with a
tiny version of Firecracker called . ([blog post on Sparkler](https://unixism.net/2019/10/sparkler-kvm-based-virtual-machine-manager/), [Sparkler github repo](https://github.com/shuveb/sparkler)). Really cool.
...
documentation on device-mapper snapshot support](https://www.kernel.org/doc/Documentation/device-mapper/snapshot.txt)
...
how Docker works.” the [kernel docs on virtio-fs](https://www.kernel.org/doc/html/latest/filesystems/virtiofs.html)
