...
slug: hosting-my-static-sites-with-nginx
word_count: 1627
---
...
of maintainance [their servers](https://blog.wesleyac.com/posts/how-i-run-my-servers) require, and
...
only serve static sites. I have about 10 static sites right now, mostly projects for [wizard zines](https://wizardzines.com).
...
[tinybuild](https://github.com/jvns/tinybuild/). It’s
...
used it before because it seemed simpler than using Puppet. Here’s [my current Ansible configuration](https://gist.github.com/jvns/06754e9e65b49dd461fefa071dd4aace),
...
(“PPP”) for countries that have a weaker currency relative to the US on [https://wizardzines.com](https://wizardzines.com). Basically it
...
The program just looks up the country code from the [geolocation HTTP header](https://support.cloudflare.com/hc/en-us/articles/200168236-Configuring-Cloudflare-IP-Geolocation)
