---
title: "A couple of Rust error messages"
date: 2022-12-02
url: https://jvns.ca/blog/2022/12/02/a-couple-of-rust-error-messages/
slug: a-couple-of-rust-error-messages
word_count: 926
---
...
I’ve been doing [Advent of Code](https://adventofcode.com/2022) in Rust for the
...
Here’s some code ([rust playground link](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=20f26bdcd30f5f8c1bccb17b36cc32de)):
...
Here’s some code ([rust playground link](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=275f94fe419f49479dabf1704068c5d3)) (This isn’t the actual code I was debugging, but it’s the fastest way to demonstrate the error message)
...
- `i32` has a static method called `sum(iter: Iterator<i32>)`, that comes from the [`Sum` trait](https://doc.rust-lang.org/std/iter/trait.Sum.html#). ([defined here for integers](https://github.com/rust-lang/rust/blob/32e613bbaafee1bcabba48a2257b838f8d1c03d3/library/core/src/iter/traits/accum.rs#L41-L47))
- `Iterator` has a `sum()` method that calls this static method on `i32` ([defined here](https://github.com/rust-lang/rust/blob/e526d123aa4703aa7b85c5b8e70c20b5ee0deade/library/core/src/iter/traits/iterator.rs#L3376-L3382))
