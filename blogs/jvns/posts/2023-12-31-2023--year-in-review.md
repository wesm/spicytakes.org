...
I published [How Integers and Floats Work](https://wizardzines.com/zines/integers-floats), which I worked on with
[Marie](https://marieflanagan.com/).
...
[Marie](https://marieflanagan.com/) made a cute interface on top of `lldb`, where you can put in any C program,
click on a line, and see what the variable looks like. It’s called [memory spy](https://memory-spy.wizardzines.com) and here’s what it looks like:


### a playground: integer exposed!


I got really obsessed with [float.exposed](https://float.exposed) by [Bartosz
Ciechanowski](https://ciechanow.ski/) for seeing how floats are represented in
memory. So with his permission, I made a copy of it for integers called [integer.exposed](https://integer.exposed).


Here’s a screenshot:


![](https://jvns.ca/images/int-exposed2.png)
...
can use to download a webpage using 100% your own networking code. Kind of like [Nand to Tetris](https://www.nand2tetris.org/), but for computer networking.
...
But in March, I released the first part: [Implement DNS in a Weekend](https://implement-dns.wizardzines.com/). The response was really good
– there are [dozens of people’s implementations on GitHub](https://github.com/search?q=dns%20weekend&type=repositories), and
...
I gave a keynote at Strange Loop this year called [Making Hard Things Easy (video + transcript)](https://jvns.ca/blog/2023/10/06/new-talk--making-hard-things-easy/),
...
- [git-commit-folders](https://github.com/jvns/git-commit-folders): a way to
...
- [git-oops](https://github.com/jvns/git-oops): an experimental prototype of an
...
This year I hired an Operations Manager for [Wizard Zines](https://wizardzines.com/)! Lee is incredible and has done SO much to
...
- the [store](https://store.wizardzines.com) has been reorganized to be way clearer!
- we’re more consistent about sending out the [new comics](https://wizardzines.com/new-comics/) newsletter!
...
spent a lot of time in 2023 working on building up a [Mastodon account](https://social.jvns.ca/@b0rk). I’ve found that I’m able to have more
...
using a single-person Mastodon server](https://jvns.ca/blog/2023/08/11/some-notes-on-mastodon/)) but overall
...
on that question this year (I wrote [What helps people get comfortable on the command line?](https://jvns.ca/blog/2023/08/08/what-helps-people-get-comfortable-on-the-command-line-/)).
...
- Could I be marketing [Mess With DNS](https://messwithdns.net/) (from 2021) more? How do I want to do that?
