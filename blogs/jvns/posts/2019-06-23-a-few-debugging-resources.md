...
slug: a-few-debugging-resources
word_count: 2243
---
...
[list some common incorrect assumptions](https://tweets.jvns.ca/b0rk/status/1142812831420768257). Here
are some examples:
...
handling library [called failure](https://github.com/rust-lang-nursery/failure) which basically lets
...
your exceptions will be separated by `The above exception was the direct cause of the following exception:..`
