...
date: 2017-04-06
url: https://jvns.ca/blog/2017/04/06/netdev-2-1/
slug: netdev-2-1
word_count: 2513
---
...
2. encoding that traffic with “sFlow” ([wikipedia article](https://en.wikipedia.org/wiki/SFlow) and sending it by UDP to some central servers that do packet analysis
3. The central servers come up with “patterns” that should be blocked
4. for example, those central servers might notice that there are a ton of suspicious-looking packets that are all from the same IP address
...
- [https://prototype-kernel.readthedocs.io/en/latest/networking/XDP/introduction.html#what-is-xdp](https://prototype-kernel.readthedocs.io/en/latest/networking/XDP/introduction.html#what-is-xdp)
...
2. you can program the network card to only put certain packets in certain
queues (“put all UDP packets from port 53 into queue 4”)
3. different applications can use different queues
...
I wrote the other day about how to [make your internet slow with tc](https://jvns.ca/blog/2017/04/01/slow-down-your-internet-with-tc/).
...
[https://www.kernel.org/doc/Documentation/memory-barriers.txt](https://www.kernel.org/doc/Documentation/memory-barriers.txt) about memory
