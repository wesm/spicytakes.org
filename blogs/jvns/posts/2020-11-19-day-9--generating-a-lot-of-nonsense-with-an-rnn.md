---
title: "Day 9: Generating a lot of nonsense with an RNN"
date: 2020-11-19
url: https://jvns.ca/blog/2020/11/19/day-9--generating-a-lot-of-nonsense-with-an-rnn/
slug: day-9--generating-a-lot-of-nonsense-with-an-rnn
word_count: 1281
---


Hello! On Monday I posted about [generating faces with
sketch-rnn](https://lots-of-sketchrnn-faces.netlify.app/), which I did using a
...
sounds vaguely
Shakespearean](https://karpathy.github.io/2015/05/21/rnn-effectiveness/).


After spending some time playing with Tensorflow, I decided to use
PyTorch with the [fast.ai](https://www.fast.ai/) helper libraries because it’s
...
computing ten [years](https://github.com/jvns/masters-thesis/) ago so this
seems okay.
...
the [cross entropy](https://en.wikipedia.org/wiki/Cross_entropy) of x and y
...
I’ve been using Google’s [Colab](https://colab.research.google.com/), which
...
like, here’s [the code I’ve written so far](https://gist.github.com/jvns/ce24d85c9d645c32b0d552b69359979f)
...
[https://fast.ai](https://fast.ai) that seems pretty good, but for whatever reason I prefer to
