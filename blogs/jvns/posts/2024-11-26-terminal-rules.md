...
to implement `Ctrl-D` support, `ipython` [does](https://github.com/prompt-toolkit/python-prompt-toolkit/blob/a2a12300c635ab3c051566e363ed27d853af4b21/src/prompt_toolkit/shortcuts/prompt.py#L824-L837). (more about that in “rule 3” below)
...
As an example of how this works in an interactive program: here’s the code [in prompt-toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit/blob/a2a12300c635ab3c051566e363ed27d853af4b21/src/prompt_toolkit/key_binding/bindings/vi.py#L2225) (the library that iPython uses for handling input)
...
For example, here’s [the code in prompt-toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit/blob/a2a12300c635ab3c051566e363ed27d853af4b21/src/prompt_toolkit/shortcuts/prompt.py#L824-L837)
that quits when you press Ctrl-D, and here’s [the same code in readline](https://github.com/bminor/bash/blob/6794b5478f660256a1023712b5fc169196ed0a22/lib/readline/readline.c#L658-L672).
