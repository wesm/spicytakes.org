...
slug: notes-on-nix-flakes
word_count: 3182
---


I’ve been using nix for about [9 months now](https://jvns.ca/blog/2023/02/28/some-notes-on-using-nix/).
...
- the way they do isolation is completely different (nix uses [dynamic linker/rpath tricks](https://github.com/NixOS/patchelf) instead of filesystem overlays, and there are no cgroups or namespaces or VMs or anything with nix)
...
do appreciate that it makes it easier for me to build a [5-year-old version of hugo on mac](https://github.com/jvns/nixpkgs/blob/main/flakes/hugo-0.40/flake.nix)
though.
...
Previously I was using nix as a Homebrew replacement like this (which I talk about more in [this blog post](https://jvns.ca/blog/2023/02/28/some-notes-on-using-nix/)):

- run `nix-env -iA nixpkgs.whatever` to install stuff
- that’s it


This worked great (except that it [randomly broke occasionally](https://github.com/NixOS/nix/issues/9340), but someone helped me
...
do that? I went to [zero-to-nix](https://zero-to-nix.com/) and copied and pasted some things and ended up with this `flake.nix` file ([here it is in a gist](https://gist.github.com/jvns/b51d4c2f04b705310cff18fcab291630)):
...
- [nixpkgs](https://github.com/NixOS/nixpkgs) is a huge central repository of nix packages
...
[mentioned in this blog post about flakes](https://www.tweag.io/blog/2020-05-25-flakes/), which says:


> Note that any file that is not tracked by Git is invisible during Nix evaluation


There’s also a [github issue](https://github.com/NixOS/nix/issues/7107) discussing what to do about this.
...
After some fiddling, I ended up with this: ([here’s a gist](https://gist.github.com/jvns/f0fa8de179cf2b14d210c9a5f9adbbd5))
...
I made a couple of flakes for custom Nix packages I’d made (which I wrote about in [my first nix blog post](https://jvns.ca/blog/2023/02/28/some-notes-on-using-nix/), and I wanted to set them up like this
(you can see the [full configuration here](https://github.com/jvns/nixpkgs/blob/f26e3db8ea929d7f228893adf973e678cc9c1741/flakes/grapefruit/flake.nix#L5-L6)):
...
I don’t really understand what’s going on here but there’s a [very long github issue thread about it](https://github.com/NixOS/nix/issues/3978).
...
just broken (looks like it’s since been [fixed](https://github.com/NixOS/nixpkgs/pull/259622) in the unstable version).
...
- edit my `flake.nix` to add or remove packages ([this file](https://github.com/jvns/nixpkgs/blob/f26e3db8ea929d7f228893adf973e678cc9c1741/flakes/grapefruit/flake.nix))
...
My solutions to all the nix problems I described are maybe not The Best (tm),
...
[flakey-profile](https://github.com/lf-/flakey-profile/) at some point though
...
[home-manager](https://github.com/nix-community/home-manager). Like I said
...
Folks on the [unofficial nix discord](https://discord.gg/RbvHtGa) have been
...
- [Nix Flakes, Part 1: An introduction and tutorial](https://www.tweag.io/blog/2020-05-25-flakes/), I think by their creator
- [xe iaso’s blog](https://xeiaso.net/blog/)
- [ian henry’s blog](https://ianthehenry.com/posts/how-to-learn-nix/)
- [the nix docs](https://nixos.org/manual/nix/stable/)
