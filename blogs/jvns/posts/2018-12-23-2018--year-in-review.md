...
At the beginning of this year I wrote [rbspy](https://github.com/rbspy/rbspy) (docs: [https://rbspy.github.io/)](https://rbspy.github.io/)). It inspired a Python version called [py-spy](https://github.com/benfred/py-spy) and a PHP profiler called [phpspy](https://github.com/adsr/phpspy/), both of which are excellent. I think py-spy in particular is [probably *better*](https://jvns.ca/blog/2018/09/08/an-awesome-new-python-profiler--py-spy-/) than rbspy which makes me really happy.
...
[https://wizardzines.com/](https://wizardzines.com/), and I sell programming zines.
...
things about that, for instance [working remotely, 4 years in](https://jvns.ca/blog/2018/02/18/working-remotely--4-years-in/)
