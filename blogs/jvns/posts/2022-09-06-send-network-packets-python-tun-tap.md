...
date: 2022-09-06
url: https://jvns.ca/blog/2022/09/06/send-network-packets-python-tun-tap/
slug: send-network-packets-python-tun-tap
word_count: 1535
---
...
connection) from a tiny Python program, and get a reply from `example.com`. All the code from this post is in [this gist](https://gist.github.com/jvns/552e6d5e6fec6c3ddf2fcd4ccdab45d5).
...
[scapy](https://scapy.net/) source code for “tun”.
...
I put all the code from this blog post in [this gist](https://gist.github.com/jvns/552e6d5e6fec6c3ddf2fcd4ccdab45d5), if you want to try it yourself, you can run
...
I’ll close with a plug for [scapy](https://scapy.net/) here: it’s a really
