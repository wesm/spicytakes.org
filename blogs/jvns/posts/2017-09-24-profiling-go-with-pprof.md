...
- Setting up a pprof webserver: [https://golang.org/pkg/net/http/pprof/](https://golang.org/pkg/net/http/pprof/)
- Generating pprof profiles in code: [https://golang.org/pkg/runtime/pprof/](https://golang.org/pkg/runtime/pprof/)
- [https://github.com/google/pprof](https://github.com/google/pprof) (from which I found out that `pprof` can read perf files!!)
- The developer docs: [https://github.com/google/pprof/blob/master/doc/pprof.md](https://github.com/google/pprof/blob/master/doc/pprof.md)
...
![](https://jvns.ca/images/pprof.png)
...
You can read the source for the memory profiler here: [https://golang.org/src/runtime/mprof.go](https://golang.org/src/runtime/mprof.go). It
...
this pull request [https://github.com/google/pprof/pull/188](https://github.com/google/pprof/pull/188) which is being worked on RIGHT NOW which
