...
date: 2021-09-20
url: https://jvns.ca/blog/2021/09/20/teaching-by-filling-in-knowledge-gaps/
slug: teaching-by-filling-in-knowledge-gaps
word_count: 1941
---


Hello! This post (like [patterns in confusing explanations](https://jvns.ca/blog/confusing-explanations/))
...
exactly how it works (like making this [shader](https://jvns.ca/blog/2020/03/15/writing-shaders-with-signed-distance-functions/)).
...
I asked [on twitter](https://twitter.com/b0rk/status/1435965181847343108) what
...
2. make a bunch of assumptions about what I think that group of people
...
3. give an explanation that assumes the person basically doesn’t know how to
program at all
...
break through abstraction boundaries, like [this performance issue that was caused by a TCP setting](https://jvns.ca/blog/2015/11/21/why-you-should-understand-a-little-about-tcp/).
...
Last year I wrote a zine called [bite size bash](https://wizardzines.com/zines/bite-size-bash/) about
