---
title: "I Shall Call It... SomethingManager"
date: 2006-03-29
url: https://blog.codinghorror.com/i-shall-call-it-somethingmanager/
slug: i-shall-call-it-somethingmanager
word_count: 578
---
...
There’s nothing more ambiguous than a `SomethingManager`. Avoid this word. Alan proposes a few alternatives in [his blog post](https://web.archive.org/web/20060619070627/http://www.bright-green.com/blog/2003_02_25/naming_java_classes_without_a.html) that might be helpful in narrowing down what your class actually does.


Giving your classes and objects good, descriptive names isn’t easy. Steve McConnell provides a few helpful guidelines for routine naming in [Code Complete](http://www.amazon.com/exec/obidos/ASIN/0735619670):
...
I’d say renaming classes and variables is one of my most frequent refactoring activities. [Creating good names is hard](http://martinfowler.com/bliki/TwoHardThings.html), but it *should* be hard, because a great name captures essential meaning in just one or two words
...
[class naming](https://blog.codinghorror.com/tag/class-naming/)
[semantic precision](https://blog.codinghorror.com/tag/semantic-precision/)
