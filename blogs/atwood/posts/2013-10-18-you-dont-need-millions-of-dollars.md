---
title: "You Don’t Need Millions of Dollars"
date: 2013-10-18
url: https://blog.codinghorror.com/you-dont-need-millions-of-dollars/
slug: you-dont-need-millions-of-dollars
word_count: 1868
---

[Masters of Doom](http://www.amazon.com/exec/obidos/ASIN/0812972155/) is the story of John Carmack and John Romero creating the seminal games Wolfenstein 3D, Doom, and Quake.


![](https://blog.codinghorror.com/content/images/2025/02/image-195.png)
...
In that spirit, Carmack regularly [releases his old engines under GPL](https://github.com/id-Software) for other programmers to learn from. Don’t miss Fabien Sanglard’s epic [deconstruction of the Doom 3 codebase](http://fabiensanglard.net/doom3/), for example. That’s only one iteration behind [the current id engine](http://en.wikipedia.org/wiki/Id_Tech_5) which was used for Rage and (apparently) will be used for the upcoming Doom 4.
...
All you have to do is get [off your butt](https://blog.codinghorror.com/good-programmers-get-off-their-butts/) and [use them](https://blog.codinghorror.com/yes-but-what-have-you-done/).

[biographies](https://blog.codinghorror.com/tag/biographies/)
