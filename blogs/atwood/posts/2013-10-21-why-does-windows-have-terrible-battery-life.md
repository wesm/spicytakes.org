...
date: 2013-10-21
url: https://blog.codinghorror.com/why-does-windows-have-terrible-battery-life/
slug: why-does-windows-have-terrible-battery-life
word_count: 1079
---

I’ve become a [huge fan of touch computing](https://blog.codinghorror.com/do-you-wanna-touch/). I believe that most things we think of as “computers” will be [de-facto tablets](https://blog.codinghorror.com/welcome-to-the-post-pc-era/), either in our pocket, in our hands, possibly even mounted on our wrists or forearms.
...
UPDATE: Turns out the Surface 2 Pro was shipped with bad firmware. Once updated, the WiFi adapter enters lower idle power states and [this helps a lot](http://www.anandtech.com/show/7460/apple-ipad-air-review), going from 6.6 hours of browsing time to 8.3 hours, a 25% improvement! That puts it much more in line with the rest of the field, at least, even if it doesn’t achieve Mac-like runtime.


It’s not exactly news that Windows historically doesn’t do as well as OS X on battery life. Way back in 2009, AnandTech [tested a MacBook Pro](http://www.anandtech.com/show/2785/the-new-macbook-pro-part-ii-lower-battery-life-under-vista-sata-issues) with multiple operating systems:
...
(It’s true that Bay Trail, Intel’s new lower power CPU from the Atom family, achieves [8.6 hours of WiFi web browsing](http://www.anandtech.com/show/7428/asus-transformer-book-t100-review/5). That’s solidly in the middle of the tablet pack for battery life. But all the evidence tells me that the very same hardware would do a *lot* better in OS X, or even iOS. At least Intel has finally produced something that’s reasonably competitive with the latest ARM chips.)
...
[surface pro](https://blog.codinghorror.com/tag/surface-pro/)
