...
slug: the-existential-terror-of-battle-royale
word_count: 1315
---

It’s been a while since I wrote a blog post, I guess in general, but also a blog post about video games. Video games are probably the single thing most [attributable to my career](https://www.google.com/search?q=site%3Ablog.codinghorror.com+%22video+games%22) as a programmer, and everything else I’ve done professionally after that. I still feel video games are one of the best ways to learn and teach programming, [if properly scoped](https://blog.codinghorror.com/heres-the-programming-game-you-never-asked-for/), and furthermore I take many [cues from video games](https://blog.codinghorror.com/level-one-the-intro-stage/) in building software.


I would characterize my state of mind for the last six to eight months as… *poor*. Not only because of [current events in the United States](https://blog.codinghorror.com/im-loyal-to-nothing-except-the-dream/), though the never-ending barrage of bad news weighs heavily on me, and I continue to be profoundly disturbed by the erosion of core values that I thought most of us stood for as Americans. Didn’t we used to look out for each other, care about each other, and fight to protect those that can’t protect themselves?
...
![](https://blog.codinghorror.com/content/images/2025/02/image-36.png)


That game is [Player Unknown’s Battlegrounds](http://store.steampowered.com/app/578080/PLAYERUNKNOWNS_BATTLEGROUNDS/). I was increasingly curious why it was so popular, and kept getting more popular every month. Calling it a mere phenomenon seems like underselling it; something truly unprecedented is happening here. I finally broke down and bought a copy for $30 in September.


![player-unknown-battleground](https://blog.codinghorror.com/content/images/2017/11/player-unknown-battleground.jpg)


After a few hours in, I had major flashbacks to the [first time I played Counter-Strike](https://blog.codinghorror.com/the-gamification/) in 1998. I realized that **we are witnessing the birth of an entirely new genre of game: the Battle Royale**. I absolutely believe that huge numbers of people will still be playing some form of this game 20 years from now, too.


![](https://blog.codinghorror.com/content/images/2025/02/image-37.png)


I’ve seen [the Japanese movie](https://en.wikipedia.org/wiki/Battle_Royale_(film)), and it’s true that there were [a few Battle Royale games](https://en.wikipedia.org/wiki/Battle_royale_game) before PUBG, but this is clearly the defining moment and game for the genre, the one that sets a precedent for everyone else to follow.
...
![battlegrounds-cargo-plane](https://blog.codinghorror.com/content/images/2017/11/battlegrounds-cargo-plane.jpg)
...
![playerunknown-battleground-drop](https://blog.codinghorror.com/content/images/2017/11/playerunknown-battleground-drop.jpg)
...
![battle-royale-vista](https://blog.codinghorror.com/content/images/2017/11/battle-royale-vista.jpg)
...
![pubg-combat](https://blog.codinghorror.com/content/images/2017/11/pubg-combat.jpg)
...
![pubg-vehicle-shooting](https://blog.codinghorror.com/content/images/2017/11/pubg-vehicle-shooting.jpg)
...
[video games](https://blog.codinghorror.com/tag/video-games/)
