...
date: 2017-03-24
url: https://blog.codinghorror.com/thunderbolting-your-video-card/
slug: thunderbolting-your-video-card
word_count: 1752
---

When I wrote about [The Golden Age of x86 Gaming](https://blog.codinghorror.com/the-golden-age-of-x86-gaming/), I *implied* that, in the future, it might be an interesting, albeit expensive, idea to upgrade your video card via an external Thunderbolt 3 enclosure.


![](https://blog.codinghorror.com/content/images/2017/03/skull-canyon-nuc-with-razer-core.jpg)
...
![4k compared to 1080p](https://blog.codinghorror.com/content/images/2015/08/common-hd-resolutions-compared.png)
...
Late in 2016, I got a [4k OLED display](https://www.amazon.com/gp/product/B01CDD4J58/) and it… kind of blew my mind. I have never seen blacks so black, colors so vivid, on a display so thin. It made my previous 2008 era Panasonic plasma set look lame. It’s so good that I’m now a little angry that every display that my eyes touch isn’t OLED already. I even got into nerd fights over it, and to be honest, I’d still throw down for OLED. It is *legitimately* that good. Come at me, bro.


Don’t believe me? Well, guess which display in the below picture is OLED? Go on, guess:


![](https://blog.codinghorror.com/content/images/2025/02/image-40.png)


![if it was physically possible to have sex with this TV I.. uh.. I'd take it on long, romantic walks](https://blog.codinghorror.com/content/images/2025/09/image-2.png)


There’s a reason every site that reviews TVs had to recalibrate their results when they [reviewed the 2016 OLED sets](http://thewirecutter.com/reviews/best-tv/).
...
![](https://blog.codinghorror.com/content/images/2017/03/razer-core-with-gpu.jpg)


The cool technology underpinning all of this is **Thunderbolt 3**. The thunderbolt cable bundled with the Razer Core is rather… diminutive. There’s [a reason for this](https://blog.startech.com/post/thunderbolt-3-the-basics/).
...
That’s more than enough bandwidth to run even the highest of high end video cards, but it is not without overhead. There’s a [mild performance hit](http://www.ultrabookreview.com/10761-razer-core-review/) for running the card externally, on the order of **15%**. There’s also a further performance hit of 10% if you are in “loopback” mode on a laptop where you don’t *have* an external display, so the video frames have to be shuttled back from the GPU to the internal laptop display.
...
And then, there I am, playing Lego Marvel in split screen co-op at glorious 3840 × 2160 UltraHD resolution on an amazing OLED display with my son. It is *incredible*.


![](https://blog.codinghorror.com/content/images/2017/03/lego-marvel-4k.jpg)
...
I would absolutely love to see a modest, dedicated $200 external Thunderbolt 3 box that included an inexpensive current-gen GPU. This would *clobber* any onboard GPU on the planet. Let’s compare my Skull Canyon NUC, which has Intel’s [fastest ever, PS4 class embedded GPU](http://www.notebookcheck.net/Intel-Iris-Pro-Graphics-580.160664.0.html), with the modest $150 [GeForce GTX 1050 Ti](http://www.notebookcheck.com/NVIDIA-GeForce-GTX-1050-Ti-Desktop.181030.0.html):
...
![](https://blog.codinghorror.com/content/images/2017/03/razer-core-and-razer-laptop.jpg)
...
[4k display](https://blog.codinghorror.com/tag/4k-display/)
