...
I wanted to ensure that never happened again2. The path I decided to
...
`spec.md` and in future sessions I can say "Consult the @spec.md and work on *some task*".
...
token spend on Amp3. I won't try to speculate whether this is expensive
...
same days I was working on this feature4. So, I think the 8 hour estimate
is generous.
...
coding sessions publicly6, with one of the reasons being that it's an
...
in the next stable Ghostty release. ↩
...
I want presenters (or anyone, really) to *want* to use Ghostty, and
caring about stuff like this is part of that. ↩
...
and very limited. 😁 ↩
5. "Final manual review" is *super super super important*. This probably
...
to avoid explaining myself further here beyond what I already have. ↩
