...
slug: the-heroes-journey
word_count: 846
---

I’m taking some time away from comma. In some ways, I feel like it’s all planned out, it only remains to see if it works or not. I rewatched  [my first Lex Fridman](https://www.youtube.com/watch?v=iwcYp-XT7UI)  and realized I hadn’t said much new on the self driving front for the past couple years. My  [two part](https://blog.comma.ai/a-100x-investment-part-1/)  blog post from 2019 remains a true description of the space.
...
1. [tinygrad](https://github.com/geohot/tinygrad)  becomes the dominant DL framework
...
From  [the Hero’s Journey](https://en.wikipedia.org/wiki/Hero%27s_journey)  wikipedia page:
...
The Bible gives us a hint, from  [Genesis 3](https://www.biblegateway.com/passage/?search=Genesis%203&version=NIV) :
...
[I need to find a portal.](https://www.youtube.com/watch?v=pb_yvBNLjNk)  Accepting hints by e-mail to find it from readers, will travel anywhere required.
