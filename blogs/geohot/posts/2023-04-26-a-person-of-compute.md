...
[LLaMA](https://arxiv.org/pdf/2302.13971.pdf)  was trained on a cluster of 2048 A100s, with ~312 TFLOPS each. 2048 is currently the most A100s that can work together on a model due to the switch topology.
...
Google is  [claiming](https://www.nextplatform.com/2022/05/11/google-stands-up-exascale-tpuv4-pods-on-the-cloud/)  they have a 9 exaflop ( [450 person](https://en.wikipedia.org/wiki/Cawker_City,_Kansas) ) computer. They bought 8 more years, that’s a computer from 24 years in the future.
...
That’s one  [Tampa](https://en.wikipedia.org/wiki/Tampa,_Florida)  of compute, which is the most we could hope to build today. A single Tampa.
