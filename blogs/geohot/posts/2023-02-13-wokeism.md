...
The  [first result](https://fairporteducationalalliance.org/what-is-wokeism%3F) :
...
The  [second result](https://en.wikipedia.org/wiki/Woke) :
...
The second result is better, but I believe “alert to racial prejudice and discrimination” doesn’t fully cover what people mean when they say someone is woke, but rather a definition to retreat to when more controversial components of wokeism are challenged, a la the  [Motte-and-bailey fallacy](https://en.wikipedia.org/wiki/Motte-and-bailey_fallacy) .
...
I tried googling “wokeism in tech”, but this got me mostly people complaining about wokeism in tech, hopefully the jump to “diversity in tech” isn’t too much, and yielded  [this page](https://www.betterup.com/blog/diversity-in-tech)  as the top result:
...
With all the talk of “representation”, I had imagined that meant woke people desired equality of outcome. This is an  [ought statement](https://en.wikipedia.org/wiki/Is–ought_problem)  and can’t be challenged with science, so I thought this is where we leave it.
...
Of course, if you are “woke” you won’t see this belief as false, and regardless of what I write here I doubt I will change your mind. But this explains what is observed with respect to the Inquisition style tactics. Believe in  [the blank slate](https://en.wikipedia.org/wiki/The_Blank_Slate)  hypothesis, or else:
...
Update: I’ve gotten replies suggesting that while equality of opportunity may not lead 100% to equality of outcome, it will at least get us closer to it, perhaps a soft wokeism. There’s actually  [evidence of the opposite](https://slatestarcodex.com/2017/08/07/contra-grant-on-exaggerated-differences/) , at least for the gender gap in tech. Meaning as equality of opportunity increases, observed outcomes diverge.
