...
I wrote a tweet about this but deleted it, since it’s a much more nuanced topic than can be discussed there. Nuclear weapons are the  [Chekhov’s gun](https://en.wikipedia.org/wiki/Chekhov%27s_gun)  on the world stage.
...
Firstly, they will not kill all humans. Probably around a third, on par with the black death or the  [Khmer Rouge](https://en.wikipedia.org/wiki/Cambodian_genocide) . And they will not create a nuclear winter ending all life. They may change the climate, but not more than the asteroid that killed the dinosaurs.
