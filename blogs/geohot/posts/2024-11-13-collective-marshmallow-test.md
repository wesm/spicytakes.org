---
title: "The Collective Marshmallow Test"
date: 2024-11-13
url: https://geohot.github.io/blog/jekyll/update/2024/11/13/collective-marshmallow-test.html
slug: collective-marshmallow-test
word_count: 637
---

Society is even harder than passing  [the marshmallow test](https://en.wikipedia.org/wiki/Stanford_marshmallow_experiment) .
...
I don’t want to become a  [hermit](https://en.wikipedia.org/wiki/J._D._Salinger) , but I feel very distant from the modern hustle and hypergambling culture. The overheard conversations in coffee shops in Hong Kong have started to trigger me, “advisors and finance influencers” can fuck off to hell. I’m a 3 hour flight from  [Devcon](https://devcon.org/en/) , but I’m not sure I can tolerate crypto culture anymore. I’ve been feeling isolated.
...
Of course, attaching yourself to the outcome of grand projects is  [no way to be happy](https://www.amazon.com/How-Found-Freedom-Unfree-World/dp/0965603679) . I wish there was still a  [retreat in academia](https://static.wikia.nocookie.net/bojackhorseman/images/5/5f/Wesleyanuniversity.png/revision/latest/scale-to-width-down/1000?cb=20200117133435) , I don’t want to participate in this shit. Back to slow and steady progress on  [tinygrad](https://github.com/tinygrad/tinygrad) .

(btw, I find it funny that people say I don’t stick to things. how many self driving car companies are even still around?  [comma](https://comma.ai/)  has been around for 9 and growing each year. and been working on tinygrad for over 4 years almost every day, see my github for proof. what have you done?)
