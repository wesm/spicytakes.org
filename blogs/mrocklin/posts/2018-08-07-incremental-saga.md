...
date: 2018-08-07
url: https://mrocklin.github.io/blog/work/2018/08/07/incremental-saga
slug: incremental-saga
word_count: 1700
---
...
that Fabian uses regularly as part of his research, and that assumes that  $f$ is the  [logistic loss](https://en.wikipedia.org/wiki/Loss_functions_for_classification#Logistic_loss) , i.e., $f(z) = \log(1 + \exp(-z))$. It can be used to solve problems with other values of $f$ by overwriting the function  `deriv_logistic` .
...
](https://mrocklin.github.io/blog/images/saga-1.png)
...
](https://mrocklin.github.io/blog/images/saga-2.png)
...
](https://mrocklin.github.io/blog/images/saga-profile.png)
...
](https://mrocklin.github.io/blog/images/saga-3.png)
