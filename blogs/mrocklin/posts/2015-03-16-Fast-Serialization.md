...
date: 2015-03-16
url: https://mrocklin.github.io/blog/work/2015/03/16/Fast-Serialization
slug: Fast-Serialization
word_count: 1075
---
...
2. JSON-no-index serializes the text values of the dataframe (not the integer
...
4. MsgPack is oddly unbalanced, it can dump text data very quickly but takes a
...
1. Both `pickle(..., protocol=2)` and `msgpack` dump raw bytes.
