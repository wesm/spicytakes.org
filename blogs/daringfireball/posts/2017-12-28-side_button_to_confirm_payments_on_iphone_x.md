...
date: 2017-12-28
url: https://daringfireball.net/2017/12/side_button_to_confirm_payments_on_iphone_x
slug: side_button_to_confirm_payments_on_iphone_x
word_count: 1045
---
...
Even after being blacklisted from the Hacker News homepage, though, the comment threads still exist. I went through [the Hacker News comments on my iPhone X review](https://news.ycombinator.com/item?id=16014464) today, and a few comments about how Apple Pay works on the iPhone X caught my attention:
...
1. The thing to keep in mind [if you watch this animation](https://daringfireball.net/misc/2017/12/double-click-to-pay) is that the “Double Click to Pay” animation is aligned perfectly with the hardware side button. ↩︎



| **Previous:** | [Apple Responds to Controversy on iPhone Batteries and Performance](https://daringfireball.net/2017/12/apple_iphone_batteries) |
| **Next:** | [ScreenShield — a Third-Party SDK That Somehow Allows iOS Apps to Prevent Screenshots](https://daringfireball.net/2018/01/screenshield) |
