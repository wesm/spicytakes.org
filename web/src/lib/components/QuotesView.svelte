              ...
              {#each yearSpicy as quote, i}
                ...
                >
                  <div class="flex items-start gap-4">
                    <div class="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full {getSpicyColor(quote.spiciness)} font-bold text-sm" title="Spiciness score: how provocative or contrarian">
                      🌶️{quote.spiciness}
                    </div>
