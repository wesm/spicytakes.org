...
{#if $selectedPost}
  ...
  <div class="fixed inset-0 z-[100] flex items-center justify-center p-4">
    ...
    <!-- Modal content -->
    <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl lg:max-w-4xl w-full max-h-[85vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
      <!-- Close button -->
      <button
        onclick={close}
        aria-label="Close"
